...
비즈니스용 Skype는 여러 고객을 동시에 지원하는 다중 테넌트 서버에서 호스팅됩니다. 이러한 서버는 Microsoft 데이터 센터에 저장되어 있으며 사용자는 회사 네트워크 내부 또는 인터넷을 통해 다양한 장치에서 이 서버에 액세스할 수 있습니다. 
...
|오디오 회의를 통한 비즈니스용 Skype 모임 전화 접속(첫 번째 파티)  <br/> |아니요  <br/> |아니요  <br/> |없음<sup>5</sup> <br/> |없음<sup>5</sup> <br/> |없음<sup>5</sup> <br/> |예  <br/> |아니요  <br/> |
...
|착신 전환 및 동시 연결  <br/> |아니요  <br/> |아니요  <br/> |아니요  <br/> |아니요  <br/> |아니요  <br/> |예  <br/> |아니요  <br/> |
...
|IM 콘텐츠 보관  <br/> |예  <br/> |없음<sup>2</sup> <br/> |없음<sup>2</sup> <br/> |없음<sup>2</sup> <br/> |예  <br/> |예  <br/> |없음<sup>2</sup> <br/> |
|전화 회의 콘텐츠 보관  <br/> |예  <br/> |없음<sup>2</sup> <br/> |없음<sup>2</sup> <br/> |없음<sup>2</sup> <br/> |예  <br/> |예  <br/> |없음<sup>2</sup> <br/> |
|응용 프로그램 공유, 데스크톱 공유 보관  <br/> |예  <br/> |아니요  <br/> |아니요  <br/> |아니요  <br/> |아니요  <br/> |아니요  <br/> |아니요  <br/> |
|사용자 수준 보관 구성  <br/> |예  <br/> |없음<sup>2</sup> <br/> |없음<sup>2</sup> <br/> |없음<sup>2</sup> <br/> |예  <br/> |예  <br/> |없음<sup>2</sup> <br/> |
...
|Microsoft Office 365 관리 센터  <br/> |아니요  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |
|비즈니스용 Skype 관리 센터  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |
|Windows PowerShell  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |
|Office 365 관리 센터의 비즈니스용 Skype Online 보고  <br/> |아니요  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |아니요  <br/> |
   
> <sup>1</sup> the Skype 비즈니스 (Lync) 클라이언트에 대 한 이러한 구독 옵션과 함께 사용 하기 위해 사용할 수 있지만 포함 되지 않습니다. Lync 2013 Basic은 모든 고객을 위해 사용할 수 있습니다. Lync Basic 데스크톱 클라이언트에는 비즈니스 Online 용 Skype를 포함 하는 Office 365 계획에 대 한 현재 상태, 인스턴트 메시징 및 회의 기능을 제공 하는 로컬에 설치 된 응용 프로그램입니다. Office 365 ProPlus 및 Office 365 Enterprise E3 고급 전화 통신 지원, 보관 및 규정 준수 기능 등의 추가 기능을 포함 하는 비즈니스 (Lync) 응용 프로그램에 대 한 전체 Skype를 포함 합니다. 각 사용자에 대 한 비즈니스 온라인 라이선스에 대 한 Skype 할당 되어야 합니다. Lync Basic 기능에 대 한 자세한 내용은 [온라인 비즈니스에 대 한 Skype에 대 한 클라이언트](https://technet.microsoft.com/en-us/library/gg425836%28v=ocs.15%29.aspx)를 참조 하십시오.<br/> <sup>2</sup>비즈니스용 Skype 온라인에 대한 보관은 이 계획에 포함되지 않은 Exchange 원본 위치 유지 기능에 따라 다릅니다. 
<br/><sup>3</sup> 사용자에 게 음성 메일을 제공할 경우 Exchange Online (계획 2) 계획을 할당 해야 합니다. 음성 메일에 대 한 Exchange Online (계획 1)는 계획을 사용할 수 없습니다.<br/><sup>4</sup> 는 Office 365 Enterprise F1 사용자는 Skype 하 여 비즈니스 온라인 계획 2 또는 엔터프라이즈 계획 사용자에 대 한 초대 하는 경우 공유 세션에 참가할 수 있습니다. 
<br/> <sup>5</sup> 오디오 회의에 추가할 수 Office 365 프리미엄, Office 365 Enterprise E1 및 Office 365 Enterprise E3 구독 계획 추가 기능으로 합니다. 
<br/> <sup>6</sup> 통신 영화 크레디트에 추가할 수 Office 365 프리미엄 구독 계획만 오디오 회의 지원 하기 위해 추가 기능으로 합니다. 
<br/><sup>7</sup> 긴급 통화 Mac 및 모바일 클라이언트에서 사용할 수 없습니다. 
<br/> <sup>8</sup> 고객 키를 사용 하면 하 조직의 암호화 키를 제어 하 고 Microsoft의 데이터 센터의 나머지 부분에서 데이터를 암호화 하 고 사용 하 여 Office 365를 구성 합니다. 보관 된 데이터에는 Exchange Online 및 사서함 및 SharePoint Online에 저장 된 파일에 저장 된 비즈니스를 위한 Skype 및 비즈니스용 OneDrive에서 데이터를 포함 합니다. 고객 키를 사용 하면 Office 365를 사용 하 여 데이터를 암호 해독의 암호화 키를 제어 하기 때문에 규정 준수 의무를 충족 합니다. 자세한 내용은 [고객 키를 사용 하 여 Office 365에서 데이터를 제어](https://go.microsoft.com/fwlink/?linkid=862702)를 참조 하십시오. 
...
|데스크톱 공유  <br/> |예  <br/> |없음<sup>2</sup> <br/> |예  <br/> |
|응용 프로그램 공유  <br/> |예  <br/> |없음<sup>2</sup> <br/> |예  <br/> |
...
|비디오 기반 화면 공유  <br/> |예  <br/> |없음<sup>2</sup> <br/> |예  <br/> |
...
|IM 콘텐츠 보관  <br/> |예  <br/> |없음<sup>3</sup> <br/> |없음<sup>3</sup> <br/> |
|전화 회의 콘텐츠 보관  <br/> |예  <br/> |없음<sup>3</sup> <br/> |없음<sup>3</sup> <br/> |
|응용 프로그램 공유, 데스크톱 공유 보관  <br/> |예  <br/> |아니요  <br/> |아니요  <br/> |
|사용자 수준 보관 구성  <br/> |예  <br/> |없음<sup>3</sup> <br/> |없음<sup>3</sup> <br/> |
...
|Microsoft Office 365 관리 센터  <br/> |아니요  <br/> |예  <br/> |예  <br/> |
|비즈니스용 Skype 관리 센터  <br/> |예  <br/> |예  <br/> |예  <br/> |
|Windows PowerShell  <br/> |예  <br/> |예  <br/> |예  <br/> |
|Office 365 관리 센터의 비즈니스용 Skype Online 보고  <br/> |아니요  <br/> |<sup>4</sup> 없음 <br/> |<sup>4</sup> 없음 <br/> |
...
<br/><sup>2</sup> A Skype 비즈니스 Online 계획 1 사용자에 대 한 비즈니스 온라인 계획 2 사용자에 대 한 Skype 하 여 사용자가 초대 하는 경우 공유 세션에 참가할 수 있습니다. 
<br/> <sup>3</sup> 비즈니스 온라인 용 Skype에 대 한 보관이이 계획에 포함 되지 않은 Exchange 원본 위치 유지 기능에 따라 달라 집니다. 
...
|||
|:-----|:-----|
|**Office 365 계획** <br/> |**비즈니스용 Skype 온라인 기능** <br/> |
|비즈니스용 Skype 온라인 독립 실행형 계획 2  <br/> | Skype 모임 브로드캐스트  <br/>  이끌이, 제작자, 이벤트 팀 구성원, 인증된 참석자는 Office 365 라이선스가 필요합니다.  <br/>  익명의 참석자는 Office 365 라이선스가 필요하지 않습니다.  <br/>  비즈니스용 Skype 온라인 독립 실행형 계획 2 또는 계획 2가 포함된 모든 Office 365 제품군을 이용하는 경우 다음의 추가 기능을 사용할 수 있습니다.  <br/>  오디 회의(제한된 국가에서 사용 가능).  <br/>  전화 시스템.  <br/> > [!NOTE]>  통화 계획 없이 단독으로 구매한 경우 클라우드 전화 시스템에서는 하이브리드 음성 기능만 사용할 수 있습니다. 기존 PSTN 서비스 공급자를 이용하여 PSTN 통화를 사용하도록 설정하려면 하이브리드 음성에 온-프레미스 고객 하이브리드 음성 배포가 필요합니다. 다음 전화 시스템 추가 기능에서는 PSTN 서비스 공급자로 Microsoft를 이용하여 인바운드/아웃바운드 PSTN 통화를 사용하도록 설정할 수 있습니다. >  국내 통화 계획(제한된 국가에서 사용 가능). >  국제 통화 계획(제한된 국가에서 사용 가능).           |
|비즈니스용 Skype 온라인 독립 실행형 계획 3  <br/> |비즈니스용 Skype 온라인 독립 실행형 계획 3.  <br/> > [!NOTE]> 이 계획은 타사 음성 서비스 공급자에 한해 사용되며 오디오 회의, 전화 시스템, 국내/국제 통화 계획 등의 통화 서비스는 제공하지  *않습니다*  .           |
|Office 365 Business Premium  <br/> | Skype 모임 브로드캐스트:  <br/>  이끌이, 제작자, 이벤트 팀 구성원, 인증된 참석자는 Office 365 라이선스가 필요합니다.  <br/>  익명의 참석자는 Office 365 라이선스가 필요하지 않습니다.  <br/>  오디오 회의(사용 가능한 국가).  <br/> |
...
|Office 365 Enterprise E5(오디오 회의 포함)  <br/> | 비즈니스용 Skype 온라인 독립 실행형 계획 2가 포함됩니다(포함된 기능은 위의 비즈니스용 Skype 온라인 독립 실행형 계획 2 참조).  <br/>  오디오 회의가 포함됩니다.  <br/>  전화 시스템이 포함됩니다.  <br/> > [!NOTE]>  통화 계획 없이 단독으로 구매한 경우 전화 시스템에서는 하이브리드 음성 기능만 사용할 수 있습니다. 기존 PSTN 서비스 공급자를 이용하여 PSTN 통화를 사용하도록 설정하려면 하이브리드 음성에 온-프레미스 고객 하이브리드 음성 배포가 필요합니다. 다음 전화 시스템 추가 기능에서는 PSTN 서비스 공급자로 Microsoft를 이용하여 인바운드/아웃바운드 PSTN 통화를 사용하도록 설정할 수 있습니다. >  국내 통화 계획(제한된 국가에서 사용 가능). >  국제 통화 계획(제한된 국가에서 사용 가능).           |

...
- [](/exchange/antispam-and-antimalware/antispam-and-antimalware) 스팸 방지 및 맬웨어 방지 보호(Exchange 관리 센터 관리 인터페이스에 대한 직접 액세스를 **통해). 기본** 제공 스팸 방지 및 맬웨어 방지 보호(여러 맬웨어 방지 엔진을 사용하여 인바운드, 아웃바운드 및 내부 메시지에서 맬웨어를 검색), 사용자 지정된 스팸 방지 및 맬웨어 방지 정책, 검역 - 관리자 관리 및 검역 - 최종 사용자 자체 관리.
...
- [**상호 연결**](/exchange/security-and-compliance/interoperability-connectivity-and-compatiblity)성, 연결 및 호환성 **:** OWA 및 비즈니스용 Skype 현재 상태, Outlook SharePoint 상호 호환성, EWS 연결 지원(가장에 적용된 EWS 앱 지원), SMTP 릴레이 지원.
...
- [**보고 기능**](/office365/servicedescriptions/exchange-online-service-description/reporting-features-and-troubleshooting-tools) 및 문제 해결 도구 **:** Microsoft 365 관리 센터 보고서, Excel 통합 문서, 웹 서비스 보고서, 통합 메시징 보고서(E3/E5 및 계획 2만 해당) 메시지 추적 [및 감사 보고서](/exchange/exchange-auditing-reports-exchange-2013-help)는 EAC(Exchange 관리 인터페이스)에 직접 액세스하여 액세스할 수 있습니다.
...
- **Exchange Server:** Exchange Server 대한 자세한 내용은 Exchange Server [기능 가용성 표를 참조](/Exchange/new-features/feature-availability)하세요.
...
- **Exchange** 새로운 기능: Exchange 관리 센터의 새로운 기능에 대한 자세한 내용은 Exchange 관리 센터의 새로운 [기능을 참조하세요](/exchange/whats-new).

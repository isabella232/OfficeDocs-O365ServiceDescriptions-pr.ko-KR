...
---
# <a name="microsoft-365-business-service-description"></a>Microsoft 365 서비스 설명

Microsoft 365 비즈니스에는 비즈니스 보호를 위해 고급 보안 및 장치 관리 기능을 가진 Office 365의 클래스에서 최고 생산성 모을 통합 된 솔루션입니다. . 이 서비스 설명에는 계획 옵션 및 기능에 설명 합니다. Office 365에 대 한 자세한 내용은 [Office 365 서비스 설명 ](office-365-service-descriptions-technet-library.md)참조 하세요.
  
## <a name="feature-availability-across-office-365-business-premium-and-microsoft-365-business-plans"></a>Office 365 프리미엄 및 Microsoft 365 비즈니스 계획 별로 사용 가능한 기능

다음 표에서 Office 365 프리미엄 및 Microsoft 365 비즈니스 계획에 대 한 플랫폼 기능을 보여줍니다.
  
Office 365 계획 별 기능 사용 가능 여부를 보려면 [Office 365 플랫폼 서비스 설명](office-365-platform-service-description/office-365-platform-service-description.md)을 참조 하세요.
...
|Office 365 관리 센터 또는 Windows PowerShell를 사용하여 Office 365 관리  <br/> |예  <br/> |예  <br/> |
...
|Azure AD 연결 동기화 도구  <br/> |예  <br/> |<sup>7</sup> 예 <br/> |
|Exchange 단순(단독형) 마이그레이션  <br/> |예  <br/> |예  <br/> |
|계정 삭제 하 고 Office 365에서 또는 Windows PowerShell<sup>8</sup> 을 사용 하 여 암호를 다시 설정 <br/> |예  <br/> |예  <br/> |
|사용자가 자신의 암호<sup>9</sup> 를 변경할 수 있습니다. <br/> |예  <br/> |예  <br/> |
|라이선스 관리  <br/> |<sup>10</sup> 예 <br/> |<sup>10</sup> 예 <br/> |
...
|Exchange Online 기반 사서함 보관  <br/> |예  <br/> |<sup>11</sup> 예 <br/> |
|메시징 레코드 관리 (MRM) 보존 태그 및 보존 정책  <br/> |예  <br/> |예  <br/> |
|보관된 데이터 암호화(BitLocker)  <br/> |예  <br/> |예  <br/> |
|Azure Information Protection을 사용한 IRM  <br/> |아니요  <br/> |<sup>6</sup> 예 <br/> |
|Office 365 메시지 암호화  <br/> |아니요  <br/> |<sup>6</sup> 예 <br/> |
...
|||
|:-----|:-----|
|**Windows 10 관리 기능** -Microsoft 365 비즈니스를 사용 하면 장치를 관리 하기 어렵습니다. Microsoft 365 비즈니스 테 넌 트를 설정 하는 경우 응용 프로그램 보호 및 장치 구성 설정을 선택 합니다. 이러한 설정은 Azure Active Directory에 참가할 때 장치에 자동으로 적용 되는 정책을 결정 합니다. Windows 10 Pro 관리 기능은 다음과 같습니다.<br/> |**Microsoft 365 Business** <br/> |
|Windows 작업을 자동화할와 단순화 된 배포  <br/> |예  <br/> |
|구독 정품 인증  <br/> |예  <br/> |
|유휴 상태에서 장치 화면을 조직 제어  <br/> |예  <br/> |
|조직 Microsoft 저장소에서 앱에 대 한 사용자 액세스 제어  <br/> |예  <br/> |
|조직 Cortana에 대 한 사용자 액세스 제어  <br/> |예  <br/> |
|조직 제어의 Windows 팁 및 Microsoft에서 광고  <br/> |예  <br/> |
|Windows 10 장치를 자동으로 최신 상태로 유지  <br/> |예  <br/> |

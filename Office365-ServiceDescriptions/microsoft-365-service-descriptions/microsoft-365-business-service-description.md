...
|**Azure AD Premium P1 사용할 수 있는 Microsoft 365 Business Premium 있습니다.**<br/>|**Microsoft 365 Business Standard** <br/> |**Microsoft 365 Business Premium** <br/> |**Enterprise Mobility + Security E3** <br/> |
...
|Microsoft Identity Manager(MIM) 사용자 CAL  <br/> |아니요  <br/> |예<sup>9</sup>  <br/> |예  <br/> |
|커넥트 상태  <br/> |아니요  <br/> |예<sup>9</sup>  <br/> |예  <br/> |
|SLA 99.9%  <br/> |예  <br/> |예  <br/> |예  <br/> |
|[장치 및 응용 프로그램 관리](/intune/fundamentals/what-is-device-management)<br/> Microsoft 365 Business Premium iOS, Android, Mac OS 및 기타 플랫폼 간 장치 관리를 위한 전체 Intune 기능이 포함되어 있습니다. <sup>8</sup> <br/> |**Microsoft 365 Business Standard** <br/> |**Microsoft 365 Business Premium** <br/> |
|PC, Mac 및 모바일 장치용 Intune MDM(모바일 장치<sup>관리) 5</sup> <br/> |아니요  <br/> |예  <br/> |
|MDM(모바일 장치 관리) 자동 등록  <br/> |아니요  <br/> |예  <br/> |
|앱 및 LOB 앱용 Intune MAM(Office 응용 프로그램 관리)<br/> |아니요  <br/> |예  <br/> |
|Windows 관리, Defender, 방화벽 정책<sup>5</sup> <br/> |아니요  <br/> |예  <br/> |
|데이터 보호 - 선택적 지우기  <br/> |예  <br/> |예  <br/> |
|정책에 대한 SG(보안 그룹) 대상 지정  <br/> |아니요  <br/> |예  <br/> |
|등록된 Office 장치에 Windows 10 앱 설치  <br/> |아니요  <br/> |예  <br/> |
|Windows Defender 구성  <br/> |아니요  <br/> |예  <br/> |
|장치 프로필 및 보안 구성<sup>배포 5</sup> <br/> |아니요  <br/> |예  <br/> |
|Enterprise Azure AD 가입을 Windows 10 상태 로밍  <br/> |아니요  <br/> |예  <br/> |
|셀프 서비스 BitLocker 복구  <br/> |아니요  <br/> |예  <br/> |
|Windows Virtual Desktop <br/> |아니요 <br/> |예 <br/> |
|**Windows 10 Pro 관리** <br/>Windows 7 및 Windows 8.1 사용이 허가된 디바이스가 있는 Professional Microsoft 365 Business Premium 업그레이드를 Windows 10 Pro. <sup>9</sup> <br/>|**Microsoft 365 Business Premium** <br/> |
|AutoPilot을 통해 Windows 간소화  <br/> |예  <br/> |
|구독 활성화  <br/> |예  <br/> |
|유휴 장치 화면의 조직 제어  <br/> |예  <br/> |
|조직에서 앱에 대한 사용자 액세스에 대한 조직 Microsoft Store  <br/> |예  <br/> |
|조직에 대한 사용자 액세스에 대한 Cortana  <br/> |예  <br/> |
|Microsoft의 Windows 및 광고에 대한 조직 제어  <br/> |예  <br/> |
|Windows 10 장치를 자동으로 최신으로 유지  <br/> |예  <br/> |
|**Windows 10 보안** <br/> |**Microsoft 365 Business Premium** <br/> |
|다음을 사용하여 바이러스 및 기타 위협으로부터 PC를 Windows Defender 바이러스 백신  <br/> |예  <br/> |
|웹 기반 위협으로부터 PC를 Microsoft Edge  <br/> |예  <br/> |
...
<sup>3</sup> Microsoft 365 Business Premium Exchange 계획 2(E3/E5)에 포함된 Exchange Online Archiving. 각 Exchange Online Archiving 구독자는 처음에 보관 사서함에 100GB의 저장소를 받습니다. 자동 확장 보관이 켜져 있는 경우 최대 저장소 용량 1.5B에 도달할 때까지 추가 저장소가 자동으로 추가됩니다. 자세한 내용은 [자동 확장 보관 개요](/microsoft-365/compliance/autoexpanding-archiving)를 참조하세요. <br/>

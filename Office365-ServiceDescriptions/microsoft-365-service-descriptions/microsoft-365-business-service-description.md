...
|Cloud app discovery  <br/> |아니요  <br/> |예 <br/> |예  <br/> |
...
|Pc, Mac 및 모바일 장치에 대 한 Intune MDM (모바일 장치 관리)<sup>5</sup> <br/> |아니요  <br/> |예  <br/> |
|MDM (모바일 장치 관리) 자동 등록  <br/> |아니요  <br/> |예  <br/> |
|Office 앱 및 LOB 앱 용 Intune MAM (모바일 응용 프로그램 관리)<br/> |아니요  <br/> |예  <br/> |
|Windows 업데이트 관리, Defender, 방화벽 정책<sup>5</sup> <br/> |아니요  <br/> |예  <br/> |
|데이터 보호-선택적 지우기  <br/> |예  <br/> |예  <br/> |
|정책에 대 한 대상 SG (보안 그룹)  <br/> |아니요  <br/> |예  <br/> |
|등록 한 Windows 10 장치에 Office 앱 설치  <br/> |아니요  <br/> |예  <br/> |
|Windows Defender 구성  <br/> |아니요  <br/> |예  <br/> |
|장치 프로필 및 보안 구성<sup>5</sup> 배포 <br/> |아니요  <br/> |예  <br/> |

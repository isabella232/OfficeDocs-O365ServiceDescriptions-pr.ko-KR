...
> [!NOTE]
> 자동 서버 쪽 레이블 지정에는 Office 365에 대한 정보 보호가 필요합니다. 프리미엄 라이선스( `MIP_S_CLP2` 또는 `efb0351d-3b08-4503-993d-383af8de41e3` ). 참조는 라이선스에 대한 제품 이름 및 서비스 계획 [식별자를 참조하세요.](https://docs.microsoft.com/azure/active-directory/enterprise-users/licensing-service-plan-reference)
...
Microsoft 365 E5/A5, Microsoft 365 E5/A5 규정 준수 및 Microsoft 365 정보 보호 및 거버넌스는 학습 가능한 분류자를 기반으로 보존 또는 기록 레이블을 자동으로 적용하는 이점을 사용자에게 제공합니다.
...
사용자는 다른 사용자와의 통신이 제한될 때 정보 장벽의 고급 규정 준수 기능을 통해 혜택을 받을 수 있습니다. 예제:<br><br>

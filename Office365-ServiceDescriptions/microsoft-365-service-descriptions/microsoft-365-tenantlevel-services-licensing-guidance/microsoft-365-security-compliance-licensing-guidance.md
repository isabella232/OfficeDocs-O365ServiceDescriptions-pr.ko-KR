...
- Exchange Online 및 비즈니스용 Skype의 경우 여기에 설명 된 대로 고객 키를 사용 하 여 사서함을 암호화 하 [고, Exchange online 및 비즈니스용 skype에 대 한 고객 키를 설정할](https://docs.microsoft.com/office365/securitycompliance/controlling-your-data-using-customer-key#office-365-setting-up-customer-key-for-exchange-online-and-skype-for-business) 수 있습니다.

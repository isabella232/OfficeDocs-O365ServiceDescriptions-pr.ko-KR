...
이 지침은 Microsoft 365 Government - GCC의 사용이 이러한 요구 사항을 충족하는 데 적합한 미국 연방, 주, 지방, 부족 또는 영토적 정부 기관 또는 정부 규정 및 요구 사항을 준수하는 데이터를 처리하는 기타 엔터티에서 Office 365 배포를 진행하는 IT 프로를 위한 것입니다.

> [!NOTE]
> 조직이 이미 Microsoft 365 Government - GCC 자격 요구 사항을 충족하고 프로그램에 적용되어 프로그램에 수락된 경우 1단계와 2단계를 건너뛰고 3단계로 바로 이동하면 됩니다.

## <a name="step-1-determine-whether-your-organization-needs-microsoft-365-government---gcc-and-meets-eligibility-requirements"></a>1단계. 조직에 Microsoft 365 Government - GCC가 필요하며 자격 요구 사항을 충족하는지 확인

Microsoft 365 Government - GCC 환경은 FedRAMP Moderate을 포함한 클라우드 서비스에 대한 미국 정부 요구 사항과 범죄 범죄 및 연방 세금 정보 시스템(CJI 및 FTI 데이터 형식)에 대한 요구 사항을 준수합니다.
...
> [!NOTE]
> Microsoft 365 Government - GCC는 미국에서만 사용할 수 있습니다. 미국 정부 이 아닌 고객은 다양한 [Office 365 Government](https://products.office.com/government/compare-office-365-government-plans)요금제에서 선택할 수 있습니다.

**결정 사항:** <br/>
- *Microsoft 365 Government - GCC가 조직에 적합한지 여부를 판단합니다.*
...
**결정 사항:** *기본 Microsoft 365 Government - GCC* 보안 설정을 수정할지 여부를 결정하여 변경 내용이 미치는 영향을 먼저 이해하도록 합니다.
...
|                                         | 정보 거버넌스: Teams에 대한 보존 정책                            | 사용할 수 있음 |
...
|                                         | 커뮤니케이션 규정 준수(감독 정책 포함): 알림 액세스 알림 서식 파일 통신 정책 대시보드 | 배포 중  |
|                                         | 통신 준수(감독 정책 포함): Advanced eDiscovery에 대한 조사를 위해 에스컬레이터 | 배포 중 |
|                                         | 커뮤니케이션 규정 준수(감독 정책 포함): 성인용 콘텐츠 검색 | 배포 중 |
|                                         | 커뮤니케이션 규정 준수: 시간의 반복적인 행동 위반 감지 | 배포 중 |
|                                         | 커뮤니케이션 규정 준수: 보다 세부적인 사용 권한 지원 | 배포 중 |
|                                         | 커뮤니케이션 준수: 프레미스 사서함을 사용하여 사용자의 Teams 채팅 데이터 분석 | 배포 중 |
|                                         | 통신 준수: 이해 상충 템플릿 | 엔지니어링 백로그 |
|                                         | 통신 준수: 전자 메일 서명 또는 고지 사항 무시 | 엔지니어링 백로그 |
|                                         | 커뮤니케이션 규정 준수: 내부자 위험 관리 전달 | 엔지니어링 백로그 |
|                                         | 통신 준수: 정책 상태 검사 및 정책을 일시 중지하는 능력 | 엔지니어링 백로그 |
|                                         | 커뮤니케이션 규정 준수: 조사 중에 상태 콘텐츠 번역 | 엔지니어링 백로그 |
|                                         | 커뮤니케이션 규정 준수: 번아웃 및 자살 감지 | 엔지니어링 백로그 |
|                                         | 정보 장벽 | 엔지니어링 백로그 |
...
|                                         | Core eDiscovery: Microsoft 규정 준수 센터가 SharePoint 및 비즈니스용 OneDrive 재생 bin에서 항목을 검색하고 내보내기 위한 지원을 확장                                        | 개발 중              |
...
|                                         | Advanced eDiscovery: Microsoft 규정 준수 센터에서 SharePoint 및 비즈니스용 OneDrive의 항목 검색 및 내보내기 지원 확장                              | 개발 중 |

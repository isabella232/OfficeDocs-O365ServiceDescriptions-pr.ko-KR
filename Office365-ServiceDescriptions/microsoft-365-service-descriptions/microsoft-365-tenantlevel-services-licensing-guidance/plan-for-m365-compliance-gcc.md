...
|                                         | 정확한 데이터 일치          | 사용할 수 있음              |
| 민감도 레이블 지정                    | Exchange Online, SharePoint Online 및 OneDrive에 대한 자동 분류 및 레이블 지정                      | 사용할 수 있음         |
...
| 정보 거버넌스                 | Teams 모임 녹음/녹화에 대한 보존 정책                            | 개발 중 |
| 정보 거버넌스                 | Teams 비공개 채널에 대한 보존 정책                            | 백로그 엔지니어링 |
| 정보 거버넌스                 | Teams 공유 채널에 대한 보존 정책                            | 백로그 엔지니어링 |
...
| 레코드 관리                     | SharePoint, 비즈니스용 OneDrive 라이브러리, 폴더 및 문서 집합에 대한 기본 레코드 레이블을 적용합니다. 및 Office 365 그룹                              | 사용할 수 있음              |
...
| 레코드 관리                     | 레코드 관리에 대한 Outlook 클라이언트 지원    | 백로그 엔지니어링 |
| 레코드 관리                     | 보존 기간 종료 시 전원 자동화 흐름    | 백로그 엔지니어링 |
...
| 커뮤니케이션 규정 준수                | 프레미스 사서함을 사용하여 사용자의 Teams 채팅 데이터 분석                         | 사용할 수 있음 |
| 커뮤니케이션 규정 준수                | 사용자가 구성원인 모든 Teams를 자동으로 모니터링                         | 사용할 수 있음 |
...
| 커뮤니케이션 규정 준수                | Advanced eDiscovery에 대한 조사 에스컬레이터                         | 사용할 수 있음 |
...
| 내부자 위험 관리             | 떠날 사용자에 의해 데이터 도난                        | 사용할 수 있음 |
| 내부자 위험 관리             | Windows 10 빌드 1809 이상에서의 활동에 대한 장치 표시기                        | 백로그 엔지니어링 |
| 내부자 위험 관리             | Advanced eDiscovery에 대한 조사 에스컬레이터                        | 사용할 수 있음 |
...
| 내부자 위험 관리             | Teams, SharePoint 사이트, 전자 메일 메시징에 대한 Office 표시기      | 사용할 수 있음              |
...
| eDiscovery                              | 핵심 eDiscovery: Microsoft 규정 준수 센터에서 SharePoint 및 비즈니스용 OneDrive의 항목 검색 및 내보내기 지원을 확장                                        | 사용할 수 있음              |
| eDiscovery                              | Advanced eDiscovery: Advanced processing                             | 사용할 수 있음 |
| eDiscovery                              | Advanced eDiscovery: 작업 매핑에 대한 관리                             | 사용할 수 있음 |
| eDiscovery                              | Advanced eDiscovery: Custodian communications                             | 사용할 수 있음 |
| eDiscovery                              | Advanced eDiscovery: Dashboard                                 | 사용할 수 있음 |
| eDiscovery                              | Advanced eDiscovery: Double Byte 문자 지원(중국어, 일본어, 한국어)                                 | 사용할 수 있음 |
...
| eDiscovery                              | Advanced eDiscovery: Teams 비공개 채널 메시지에 대한 법적 보유            | 사용할 수 있음 |
| eDiscovery                              | Advanced eDiscovery: Microsoft 준수 센터에서 SharePoint 및 비즈니스용 OneDrive의 항목을 검색하고 내보내기 위한 지원이 확장됩니다.            | 개발 중 |
| eDiscovery                              | Advanced eDiscovery: 거의 중복 식별                               | 사용할 수 있음 |
| eDiscovery                              | Advanced eDiscovery: 새로운 예측 코딩 모듈                   | 백로그 엔지니어링 |
| eDiscovery                              | Advanced eDiscovery: 비보조 데이터 원본                                  | 사용할 수 있음 |
| eDiscovery                              | Advanced eDiscovery: 비 Office 365 Ingestion                                    | 사용할 수 있음 |
| eDiscovery                              | Advanced eDiscovery: 예측 코딩                                       | 사용할 수 있음 |
| eDiscovery                              | Advanced eDiscovery: 로드 파일로 내보내기 처리                   | 사용할 수 있음 |
| eDiscovery                              | Advanced eDiscovery: Redactions                        | 사용할 수 있음 |
| eDiscovery                              | 고급 eDiscovery: 검토 집합                                     | 사용할 수 있음 |
| eDiscovery                              | Advanced eDiscovery: 데이터(쿼리 데이터, 스마트 태그, 대시보드)를 검토하고 주석을 작성(변경)                             | 사용할 수 있음 |
| eDiscovery                              | 고급 eDiscovery: 검색 용어 보고서                        | 사용할 수 있음 |
| eDiscovery                              | Advanced eDiscovery: 단일 항목 오류 수정                              | 사용할 수 있음 |
| eDiscovery                              | Advanced eDiscovery: Support PST Export                              | 사용할 수 있음 |
| eDiscovery                              | Advanced eDiscovery: OneDrive 및 SharePoint Online의 연결된 콘텐츠 지원(최신 첨부 파일)                              | 사용할 수 있음 |
| eDiscovery                              | Advanced eDiscovery: Teams 반응 지원                      | 백로그 엔지니어링 |
| eDiscovery                              | Advanced eDiscovery: Tagging                              | 사용할 수 있음 |
| eDiscovery                              | Advanced eDiscovery: 테넌트 보고서                              | 사용할 수 있음 |
| eDiscovery                              | Advanced eDiscovery: Themes                              | 사용할 수 있음 |
| eDiscovery                              | Advanced eDiscovery: Viewers                              | 사용할 수 있음 |
| eDiscovery                              | Advanced eDiscovery: Yammer 준수 센터의 Advanced eDiscovery                              | 사용할 수 있음 |
| 감사                                   | 기본 감사                              | 사용할 수 있음 |
| 감사                                   | 고급 감사: 중요한 이벤트에 대한 액세스(예: *MailItemsAccessed*)                              | 사용할 수 있음 |
| 감사                                   | 고급 감사: 관리 활동 API에 대한 대역폭 증가                   | 사용할 수 있음 |
| 감사                                   | 고급 감사: Teams 비공개 채널 메시지에 대한 법적 보유                   | 사용할 수 있음 |
| 감사                                   | 고급 감사: 로그 보존(1년)                               | 사용할 수 있음 |
| 감사                                   | 고급 감사: 감사 로그에 대한 장기 보존(10년)              | 개발 중 |
| 감사                                   | 고급 감사: 메일 전달 및 메일 보내기 이벤트                               | 사용할 수 있음 |
| 감사                                   | 고급 감사: Microsoft 365 보안 및 준수 센터                    | 사용할 수 있음 |
| 감사                                   | 고급 감사: Exchange Online 및 SharePoint Online의 검색 용어 이벤트                              | 백로그 엔지니어링 |

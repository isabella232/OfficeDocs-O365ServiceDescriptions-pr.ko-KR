...
| | 다중 Microsoft 365 암호화를 위한 고객 키 | 사용 가능 |
...
| | 정보 거버넌스: SharePoint, 비즈니스용 OneDrive, 폴더 및 문서 집합에 대한 기본 보존 레이블 Exchange 받은 편지함; 및 Office 365 그룹 | 사용 가능 |
...
| | Advanced eDiscovery: 작업 매핑에 대한 관리 | 사용 가능 |
...
| | 타사 데이터 커넥터(17a-4 및 CellTrust 커넥터) | 개발 중 |

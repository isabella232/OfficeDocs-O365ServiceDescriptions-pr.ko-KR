...
- Microsoft 365 정부 - GCC 정부는 미국 공공 부문 고객에게 필요한 인증 및 인증을 준수합니다.
...
| | 정보 거버넌스: 보존 기간 종료 시 보존 레이블 작업 적용 | 개발 중 |
...
| | 레코드 관리: Power Automate Flow 종료 시 관리 | 백로그 엔지니어링 |
| | 레코드 관리: 폐기 증명 | 사용 가능 |
...
| | 타사 데이터 커넥터(17a-4 및 CellTrust 커넥터) | 사용 가능 |

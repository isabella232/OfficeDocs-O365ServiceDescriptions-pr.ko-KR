...
| 민감도 레이블 지정 | 웹, Android, iOS, Outlook 및 Mac에서 Office 앱(Word, Excel, PowerPoint, Outlook)에 대한 자동 분류 및 Windows 레이블 지정 | 사용할 수 있음 |
| 민감도 레이블 지정 | Office 클라이언트에 대한 자동 분류 및 레이블 지정(모바일) | 백로그 엔지니어링 |
| 민감도 레이블 지정 | Teams, Microsoft 365 그룹 및 SharePoint 분류 및 레이블 지정 | 사용할 수 있음 |
...
| | 정보 거버넌스: 관리에 대한 Teams | 배포 중 |
| | 정보 거버넌스: 모임 Teams 보존 정책 | 개발 중 |
| | 정보 거버넌스: 개인 채널에 Teams 정책 | 백로그 엔지니어링 |
...
| 커뮤니케이션 규정 준수 | 정책 상태 검사 및 정책 일시 중지 능력 | 백로그 엔지니어링 |
| 커뮤니케이션 규정 준수 | 파워 자동화 통합 | 백로그 엔지니어링 |
| 커뮤니케이션 규정 준수 | 위협, 대상 괴롭음 및 비언어 분류자에 대한 7개 언어 지원 | 백로그 엔지니어링 |
| 커뮤니케이션 규정 준수 | 보다 세분화된 사용 권한 지원 | 사용할 수 있음 |
| 커뮤니케이션 규정 준수 | 메시지 제거 Teams, Exchange 및 기능을 Teams 지원 | 사용할 수 있음 |
| 커뮤니케이션 규정 준수 | Microsoft Teams 통합 | 백로그 엔지니어링 |
| 커뮤니케이션 규정 준수 | Teams 대화 컨텍스트 | 백로그 엔지니어링 |
...
| 권한이 부여된 액세스 관리 | 권한이 부여된 액세스 관리 | 백로그 엔지니어링 |
...
| eDiscovery | Advanced eDiscovery: Custodian에서 작업으로의 매핑 | 사용할 수 있음 |
| eDiscovery | Advanced eDiscovery: Custodian communications | 사용할 수 있음 |
| eDiscovery | Advanced eDiscovery: 대시보드 | 사용할 수 있음 |
| eDiscovery | Advanced eDiscovery: 중국어, 일본어 및 한국어에 대한 더블 Byte 지원 | 사용할 수 있음 |
| eDiscovery | Advanced eDiscovery: 전자 메일 스레딩 | 사용할 수 있음 |
| eDiscovery | Advanced eDiscovery: 내보내기(다운로드, 내보내기, 다른 검토 집합에 추가) | 사용할 수 있음 |
...
| 감사 | 고급 감사: Microsoft 365 및 준수 센터 가용성 | 사용할 수 있음 |

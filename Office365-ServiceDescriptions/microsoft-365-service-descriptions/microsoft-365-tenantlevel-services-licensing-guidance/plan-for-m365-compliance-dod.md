...
| | 정확한 데이터 일치 | 사용할 수 있음 |
| | Exchange Online, SharePoint Online 및 비즈니스용 OneDrive | 배포 중 |
| | 플랫폼(웹, Office 및 Mac)에서 Office 앱(Word, Excel, PowerPoint, Outlook)에 대한 자동 분류 Windows 및 레이블 지정 | 사용할 수 있음 |
...
| | 메시지에 대한 암호화 전용 보호를 위한 Outlook 레이블 구성 | 배포 중 |
| **분석** | 데이터 분류: 개요 및 콘텐츠 탐색기 | 배포 중 |
| | 분석: 서비스 쪽에서 자동 레이블을 지정하는 기계 학습 분류자 | 개발 중 |
| | 분석: 앱/클라이언트 쪽에서 자동 Office 기계 학습 분류자 | 배포 중 |
...
| | DLP: 경고 대시보드 | 배포 중 |
| | DLP 끝점 | 개발 중 |
| | DLP On-prem | 백로그 엔지니어링 |
| | DLP 개요 페이지 | 개발 중 |
| **정보 거버넌스** | 정보 거버넌스: 전자 메일 보관 | 사용할 수 있음 |
| | 정보 거버넌스: 보존 잠금 | 사용할 수 있음 |
| | 정보 거버넌스: PST 가져오기 | 사용할 수 있음 |
| | 정보 거버넌스: 수동으로 레코드가 아닌 보존 레이블 적용 | 사용할 수 있음 |
| | 정보 거버넌스: SharePoint/비즈니스용 OneDrive 라이브러리, 폴더 및 문서 집합에 대한 기본 보존 레이블을 적용합니다. Exchange 받은 편지함; 및 Office 365 그룹 | 사용할 수 있음 |
| | 정보 거버넌스: 전체 조직에 단일 기본 보존 레이블을 적용합니다. 특정 위치 또는 사용자 특정 조건(예: 키워드 또는 중요한 정보)에 따라 자동으로 | 사용할 수 있음 |
| | 정보 거버넌스: 받은 편지함의 기본 Exchange 적용 | 사용할 수 있음 |
| | 정보 거버넌스: 다단계 분해 검토 | 백로그 엔지니어링 |
| | 정보 거버넌스: 교육 가능한 분류자 보유 정책 | 개발 중 |
| | 정보 거버넌스: 채팅에 대한 Teams 정책 | 배포 중 |
| | 정보 거버넌스: 모임 Teams 보존 정책 | 사용할 수 있음 |
| | 정보 거버넌스: 비공개 채널 Teams 보존 정책 | 백로그 엔지니어링 |
...
| | 내부자 위험 관리: 떠날 사용자의 데이터 도용 | 배포 중 |
| | 내부자 위험 관리: 일반 데이터 누수 | 배포 중 |
| | 내부자 위험 관리: 내부자 위험 관리 경고 조사 | 배포 중 |
| | 내부자 위험 관리: Office, Teams, SharePoint 메시지에 대한 표시기입니다. | 배포 중 |
| | 내부자 위험 관리 활동 탐색기 | 백로그 엔지니어링 |
...
| | 통신 준수: 전자 메일 서명 또는 고지 사항 무시 | 개발 중 |
| | 통신 준수: 통신 준수 정책에 대한 보존 기간을 설정하는 능력 | 백로그 엔지니어링 |
| | 커뮤니케이션 규정 준수: 성인용 콘텐츠 검색 | 백로그 엔지니어링 |
| | 커뮤니케이션 규정 준수: 내부자 위험 관리 전달 | 개발 중 |
| | 통신 준수: 정책 상태 검사 및 정책 일시 중지 능력 | 개발 중 |
| | 커뮤니케이션 규정 준수: 위협, 대상 괴롭음 및 비언어 분류자에 대한 7개 언어 지원 | 개발 중 |
...
| | 핵심 eDiscovery: 핵심 eDiscovery: 비즈니스용 OneDrive | 배포 중 |
| | Advanced eDiscovery: 고급 처리 | 사용할 수 있음 |
| | Advanced eDiscovery: CJK/Double byte는 Advanced eDiscovery | 사용할 수 있음 |
...
| | Advanced eDiscovery: 검토 및 주석 작성 | 사용할 수 있음 |
...
| | 고급 감사: 온라인 및 Exchange Online SharePoint 검색 | 백로그 엔지니어링 |
...
| | 자체 데이터 커넥터: Instant Bloomberg, Bloomberg Mail, LinkedIn Business 페이지, ICE Chat | 백로그 엔지니어링 |

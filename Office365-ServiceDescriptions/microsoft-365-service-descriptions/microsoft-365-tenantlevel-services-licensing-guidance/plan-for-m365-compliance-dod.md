...
|                                         | 팀, SharePoint 사이트, 전자 메일 메시지에 대 한 Office 지표                         | 엔지니어링 백로그 |
|                                         | Departing 사용자의 데이터 도난                        | 엔지니어링 백로그 |
|                                         | 일반 데이터 누수                                | 엔지니어링 백로그              |
|                                         | 참가자 위험 관리 알림 조사                                   | 엔지니어링 백로그              
|                                         | 참가자 위험 관리 사례 대시보드, 콘텐츠 탐색기 및 알림 서식 파일 | 엔지니어링 백로그 |
|                                         | Advanced eDiscovery에 대 한 조사 확대 |엔지니어링 백로그|
...
|                                         | 고객 정책 만들기, 통신 준수를 위해 미리 구성 된 3 incl (감독 정책)  | 엔지니어링 백로그 |
|                                         | 팀, Exchange 및 팀 제거 메시지에 대 한 통신 준수 (incl (감독 정책) 지원 |엔지니어링 백로그 |
|                                         | 통신 준수 (incl 정책) 액세스 경고 참고 서식 파일 통신 정책 대시보드 |엔지니어링 백로그  |
|                                         | Advanced eDiscovery에 대 한 통신 준수 (incl 정책) 확대 조사 | 엔지니어링 백로그 |
|                                         | 통신 준수 (incl-감독 정책) 성인 콘텐츠 검색 | 엔지니어링 백로그 |
|                                         | 정보 장벽 | 엔지니어링 백로그 |

...
ms.locfileid: "51173533"
---
# <a name="plan-for-microsoft-365-compliance---dod-deployments"></a>Microsoft 365 규정 준수 - DoD 배포 계획

이 지침은 Microsoft 365 Government – DoD를 사용하는 것이 이러한 요구 사항을 충족하는 데 적합한 미국 연방 정부 기관 또는 정부 규정 및 요구 사항을 준수하는 데이터를 처리하는 기타 엔터티에서 Office 365 배포를 진행하는 IT 프로를 위한 것입니다.

> [!NOTE]
> 조직이 이미 Microsoft 365 Government – DoD 자격 요구 사항을 충족하고 프로그램에 적용되고 프로그램에 수락된 경우 1단계와 2단계를 건너뛰고 3단계로 바로 이동하면 됩니다.

## <a name="step-1-determine-whether-your-organization-needs-microsoft-365-government---dod-and-meets-eligibility-requirements"></a>1단계. 조직에 Microsoft 365 Government - DoD가 필요한지 여부 및 자격 요구 사항을 충족하는지 확인

Microsoft 365 Government - DoD 환경은 클라우드 서비스에 대한 미국 정부 요구 사항을 준수합니다.

조직은 Office 365의 기능과 기능을 즐길 수 있는 것 외에도 Microsoft 365 Government - DoD에 고유한 다음과 같은 기능을 사용할 수 있습니다.
...
자격 요구 사항을 포함하여 [Office 365 Government](https://products.office.com/government/compare-office-365-government-plans)요금제에서 미국 정부 고객을 위한 Microsoft 365 Government - DoD 제공에 대한 자세한 정보를 찾을 수 있습니다.
...
**결정 사항**:<br/>
- *Microsoft 365 Government - DoD가 조직에 적합한지 여부를 결정하십시오.*
- *조직이 자격 요구 사항을 충족하는지 확인합니다.*

> [!NOTE]
> Microsoft 365 Government - DoD는 미국에서만 사용할 수 있습니다. 미국 정부 이 아닌 고객은 다양한 [Office 365 Government 요금제에서](https://products.office.com/government/compare-office-365-government-plans)선택할 수 있습니다.

## <a name="step-2-apply-for-microsoft-365-government---dod"></a>2단계. Microsoft 365 Government 신청 - DoD
...
|                                         | 모바일에 대한 자동 분류 및 레이블 지정                                       | 백로그 엔지니어링              |
|                                         | Teams에 대한 자동 분류 및 레이블 지정                            | 백로그 엔지니어링 |
|                                         | 데이터 분류: 개요 및 콘텐츠 탐색기                            | 개발 중 |
...
|                                         | Teams 채팅 및 채널 대화용 DLP         | 백로그 엔지니어링 |
|                                         | DLP 정확한 데이터 일치         | 백로그 엔지니어링 |
|                                         | DLP 끝점 | 백로그 엔지니어링 |
...
|                                         | 정보 거버넌스: 전체 조직에 대한 보존 정책 특정 위치 또는 사용자 특정 조건(예: 키워드 또는 중요한 정보)에 따라 자동으로                                       | 사용할 수 있음              |
|                                         | 정보 거버넌스: 교육 가능한 분류자 보유 정책                            | 백로그 엔지니어링 |
|                                         | 정보 거버넌스: Teams 모임 녹음/녹화에 대한 보존 정책                            | 백로그 엔지니어링 |
|                                         | 정보 거버넌스: Yammer 및 Teams에 대한 보존 정책                           | 백로그 엔지니어링              |
...
|                                         | 레코드 관리: 규정 레코드 | 백로그 엔지니어링 |
|                                         | 레코드 관리: 다단계 분해 검토 | 백로그 엔지니어링 |
|                                         | 레코드 관리: SharePoint Syntex 분류를 사용하여 레코드 레이블 적용         | 백로그 엔지니어링 |
| **내부 위험 관리**             | 고객 Lockbox                                | 사용할 수 있음            |
|                                         | 내부자 위험 관리: Teams, SharePoint 사이트, 전자 메일 메시징에 대한 Office 표시기                         | 백로그 엔지니어링 |
|                                         | 내부자 위험 관리: 떠날 사용자의 데이터 도용                        | 백로그 엔지니어링 |
|                                         | 내부자 위험 관리: 일반 데이터 누수                                | 백로그 엔지니어링              |
|                                         | 내부자 위험 관리: 내부자 위험 관리 경고 조사                                   | 백로그 엔지니어링              |
|                                         | 내부자 위험 관리: 사례 대시보드, 콘텐츠 탐색기 및 알림 서식 파일 | 백로그 엔지니어링 |
|                                         | 내부자 위험 관리: Advanced eDiscovery에 대한 조사 에스컬레이터 |백로그 엔지니어링|
...
|                                         | 커뮤니케이션 규정 준수(감독 정책 포함): 고객 정책 만들기, 미리 구성된 3  | 백로그 엔지니어링 |
|                                         | 커뮤니케이션 규정 준수(감독 정책 포함): Teams 지원, Exchange 및 Teams 메시지 제거 | 백로그 엔지니어링 |
|                                         | 커뮤니케이션 규정 준수(감독 정책 포함): 경고 액세스 알림 서식 파일 통신 정책 대시보드 | 백로그 엔지니어링  |
|                                         | 커뮤니케이션 규정 준수(감독 정책 포함): Advanced eDiscovery에 대한 조사를 위해 에스컬레이터 | 백로그 엔지니어링 |
|                                         | 커뮤니케이션 규정 준수(감독 정책 포함): 성인용 콘텐츠 검색 | 백로그 엔지니어링 |
|                                         | 커뮤니케이션 규정 준수(포함. 감독 정책): 시간이 지날 때 반복되는 행동 위반을 감지합니다. | 배포 중 |
|                                         | 커뮤니케이션 규정 준수(감독 정책 포함): 보다 세부적인 사용 권한 지원 | 배포 중 |
|                                         | 커뮤니케이션 규정 준수(감독 정책 포함): 프레미스 사서함을 사용하여 사용자의 Teams 채팅 데이터 분석 | 배포 중 |
|                                         | 커뮤니케이션 규정 준수(감독 정책 포함): 이해 상충 템플릿 | 백로그 엔지니어링 |
|                                         | 통신 준수(감독 정책 포함): 전자 메일 서명 또는 고지사항을 무시하는 능력 | 백로그 엔지니어링 |
|                                         | 커뮤니케이션 규정 준수(감독 정책 포함): 내부자 위험 관리 전달 | 백로그 엔지니어링 |
|                                         | 통신 준수(감독 정책 포함): 정책 상태 검사 및 정책 일시 중지 능력 | 백로그 엔지니어링 |
|                                         | 커뮤니케이션 규정 준수(감독 정책 포함): 조사 중에 상태 콘텐츠 번역 | 백로그 엔지니어링 |
|                                         | 커뮤니케이션 규정 준수(감독 정책 포함): 번아웃 및 자살 감지 | 백로그 엔지니어링 |
|                                         | 정보 장벽 | 백로그 엔지니어링 |
...
|                                         | Advanced eDiscovery: Advanced processing                                 | 배포 중 |
|                                         | Advanced eDiscovery: Custodian에서 워크로드로의 매핑                                 | 배포 중 |
|                                         | Advanced eDiscovery: Custodian communications                                 | 배포 중 |
|                                         | Advanced eDiscovery: Dashboard                   | 배포 중 |
|                                         | Advanced eDiscovery: 전자 메일 스레딩                                          | 배포 중 |
|                                         | 고급 eDiscovery: 내보내기(다운로드, 내보내기, 다른 검토 집합에 추가)                               | 배포 중 |
|                                         | Advanced eDiscovery: 필터링                 | 배포 중 |
|                                         | Advanced eDiscovery: Teams 비공개 채널 메시지에 대한 법적 보유                                         | 배포 중 |
|                                         | Advanced eDiscovery: 거의 중복 식별                                         | 배포 중 |
|                                         | Advanced eDiscovery: 비 Office 365 Ingestion                                      | 배포 중 |
|                                         | Advanced eDiscovery: 예측 코딩                                       | 배포 중 |
|                                         | Advanced eDiscovery: 로드 파일로 내보내기 처리                   | 배포 중 |
|                                         | Advanced eDiscovery: Redactions                        | 배포 중 |
|                                         | 고급 eDiscovery: 검토 집합                                     | 배포 중 |
|                                         | Advanced eDiscovery: 검토 및 주석 작성                             | 배포 중 |
|                                         | 고급 eDiscovery: 검색 용어 보고서                        | 배포 중 |
|                                         | Advanced eDiscovery: OneDrive 및 SharePoint Online의 연결된 콘텐츠 지원(최신 첨부 파일)                        | 배포 중 |
|                                         | Advanced eDiscovery: Tagging                              | 배포 중 |
|                                         | Advanced eDiscovery: Teams 반응 지원                              | 배포 중 |
|                                         | Advanced eDiscovery: 테넌트 보고서                              | 배포 중 |
|                                         | Advanced eDiscovery: Themes                              | 배포 중 |
|                                         | Advanced eDiscovery: Viewers                              | 배포 중 |
|                                         | Advanced eDiscovery: Yammer 준수 센터의 Advanced eDiscovery                              | 배포 중 |
|                                         | Advanced eDiscovery: Advanced eDiscovery에 대한 CJK/Double byte 지원                              | 개발 중 |
|                                         | 기본 감사                              | 사용할 수 있음 |
|                                         | 고급 감사: 중요한 이벤트에 대한 액세스(예: mailitemsaccessed)                              | 배포 중 |
|                                         | 고급 감사: 관리 활동 API에 대한 대역폭 증가                              | 배포 중 |
|                                         | 고급 감사: 로그 보존(1년)                              | 배포 중 |

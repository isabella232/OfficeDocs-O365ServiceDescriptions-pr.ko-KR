...
description: 이 지침은 Microsoft 365 Government - DoD의 사용이 이러한 요구 사항을 충족하는 데 적합한 미국 연방 정부 기관 또는 정부 규정 및 요구 사항을 준수하는 데이터를 처리하는 기타 엔터티에서 Office 365의 배포를 진행하는 IT 프로를 위한 것입니다.
...
ms.locfileid: "49601723"
---
# <a name="plan-for-microsoft-365-compliance---dod-deployments"></a>Microsoft 365 규정 준수 - DoD 배포 계획

이 지침은 Microsoft 365 Government - DoD의 사용이 이러한 요구 사항을 충족하는 데 적합한 미국 연방 정부 기관 또는 정부 규정 및 요구 사항을 준수하는 데이터를 처리하는 기타 엔터티에서 Office 365의 배포를 진행하는 IT 프로를 위한 것입니다.

> [!NOTE]
> 조직이 이미 Microsoft 365 Government – DoD 자격 요구 사항을 충족하고 프로그램에 적용되어 프로그램에 수락된 경우 1단계와 2단계를 건너뛰고 3단계로 바로 이동하면 됩니다.

## <a name="step-1-determine-whether-your-organization-needs-microsoft-365-government---dod-and-meets-eligibility-requirements"></a>1단계. 조직에 Microsoft 365 Government가 필요한지 여부 확인 - DoD 및 자격 요구 사항 충족

Microsoft 365 Government - DoD 환경은 클라우드 서비스에 대한 미국 정부 요구 사항을 준수합니다.

조직은 Office 365의 기능과 기능을 즐길 뿐만 아니라 Microsoft 365 Government - DoD에 고유한 다음과 같은 기능을 사용할 수 있습니다.
...
자격 요구 사항을 포함하여 Office 365 Government 요금제에서 미국 정부 고객을 위한 [Microsoft 365 Government](https://products.office.com/government/compare-office-365-government-plans)- DoD 제공에 대한 자세한 정보를 찾을 수 있습니다.
...
> [!NOTE]
> Microsoft 365 Government - DoD는 미국에서만 사용할 수 있습니다. 미국 정부 이 아닌 고객은 다양한 [Office 365 Government](https://products.office.com/government/compare-office-365-government-plans)요금제에서 선택할 수 있습니다.

## <a name="step-2-apply-for-microsoft-365-government---dod"></a>2단계. Microsoft 365 Government 적용 - DoD
...
**결정 사항:** *기본 Microsoft 365 Government - DoD* 보안 설정을 수정할지 여부를 결정하여 변경 내용이 미치는 영향을 먼저 파악합니다.
...
|                                         | 모바일에 대한 자동 분류 및 레이블 지정                                       | 엔지니어링 백로그              |
...
|                                         | 내부자 위험 관리: Teams, SharePoint 사이트, 전자 메일 메시징에 대한 Office 표시기                         | 엔지니어링 백로그 |
|                                         | 내부자 위험 관리: 사용자를 떠날 때 데이터 도용                        | 엔지니어링 백로그 |
|                                         | 내부자 위험 관리: 일반 데이터 누수                                | 엔지니어링 백로그              |
|                                         | 내부자 위험 관리: 내부자 위험 관리 경고 조사                                   | 엔지니어링 백로그              |
|                                         | 내부자 위험 관리: 사례 대시보드, 콘텐츠 탐색기 및 알림 서식 파일 | 엔지니어링 백로그 |
|                                         | 내부자 위험 관리: Advanced eDiscovery에 대한 조사 에스컬레이터 |엔지니어링 백로그|
...
|                                         | 커뮤니케이션 규정 준수(감독 정책 포함): 고객 정책 만들기, 미리 구성된 3  | 엔지니어링 백로그 |
|                                         | 커뮤니케이션 규정 준수(감독 정책 포함): Teams 지원, Exchange 및 Teams 메시지 제거 | 엔지니어링 백로그 |
|                                         | 커뮤니케이션 규정 준수(감독 정책 포함): 알림 액세스 알림 서식 파일 통신 정책 대시보드 | 엔지니어링 백로그  |
|                                         | 커뮤니케이션 규정 준수(감독 정책 포함): Advanced eDiscovery에 대한 조사를 위해 에스컬레이터 | 엔지니어링 백로그 |
|                                         | 커뮤니케이션 규정 준수(감독 정책 포함): 성인용 콘텐츠 검색 | 엔지니어링 백로그 |
|                                         | 커뮤니케이션 준수(포함: 감독 정책): 시간이 지날 때 반복되는 행동 위반을 감지합니다. | 배포 중 |
...
|                                         | 고급 감사: 관리 작업 API에 대한 대역폭 증가                              | 배포 중 |
|                                         | 고급 감사: 로그 보존(1년)                              | 배포 중 |

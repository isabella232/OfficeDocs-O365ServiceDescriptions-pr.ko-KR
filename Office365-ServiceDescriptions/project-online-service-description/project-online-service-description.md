...
|로드맵 | Microsoft Project Online, Microsoft Project for web 및 Azure 보드용 프로젝트 간에 시각적, 대화형 로드맵를 작성 합니다. <sup>2</sup>   프로젝트 계획 1을 사용 하 여 로드맵에 대 한 읽기 전용 액세스 권한을 얻을 수 있습니다. 프로젝트 계획 3 또는 프로젝트 계획 5를 사용 하 여 로드맵를 만들 수도 있습니다. | 보기 전용 | 보기 전용 | 예 | 예 |
|**보고**<sup>3</sup> ||||||
|기본 보고 기능 | 미리 작성 된 보고서를 사용 하 여 프로젝트, 프로그램, 포트폴리오 및 자원 데이터를 이해 합니다. | 아니요 | 예 | 예 | 예 |
|사용자 지정 보고서 | 기본 보고서를 기반으로 사용자 지정 보고서를 작성 하거나 처음부터 사용 하 여 조직에서 중요 한 데이터를 이해 합니다. | 아니요 | 예 | 예 | 예 |
|대시보드 및 포털 | 특정 조직 요구 사항을 충족 하는 데 도움이 되는 사용자 지정 대시보드 및 포털을 작성 합니다.| 아니요 | 예 | 예 | 예 |
|**편의성이** ||||||
...
|**사용자 지정 및 통합**||||||
|PowerApps | PowerApps를 사용 하 여 웹 및 mobile 용 솔루션을 구축 및 사용 합니다. <sup>4</sup> | 아니요 | 아니요 | 예 | 예 |
|Workflows | 비즈니스 프로세스를 자동화 하 고 전원 자동화로 통합 합니다. <sup>5</sup> | 아니요 | 아니요 | 예 | 예 |
|Microsoft 통합 | 익숙한 Microsoft 도구 및 응용 프로그램을 사용 하 여 공동 작업, 문서 관리 등을 수행 합니다. <sup>1</sup> | 예 | 예 | 예 | 예 |
|**보안 및 사용자 관리**||||||
...
<sup>3</sup> Power BI를 사용 하 여 웹 및 project Online 용 프로젝트에 대 한 보고를 사용할 수 있습니다. 보고서를 보고 편집 하 고 만들기 위해서는 Power BI 구독이 필요 합니다. Microsoft는 미리 작성 된 Power BI 보고서 집합을 제공 합니다. 사용자는 Power BI를 사용 하 여 이러한 보고서를 사용자 지정 하거나 추가 보고서를 작성할 수 있습니다.</br> 

...
이 다이어그램에서는 응용 프로그램이 나란히 함께 작동 하는 방식을 보여 줍니다.
...
Microsoft Project는 조직의 요구 사항을 가장 잘 충족 하기 위해 세 가지 다른 구독을 통해 제공 됩니다. 이러한 구독은 프로젝트 계획 1, 프로젝트 계획 3 및 프로젝트 계획 5입니다. 다양 한 구독에서 기능을 비교 하려면 [응용 프로그램 및 구독 별 기능 가용성](#feature-availability-across-applications-and-subscriptions)을 참조 하십시오.<br><br>
...
위 표에서 검사 횟수 (**x**)는 요금제에서 제공 하는 일반적인 기능 수준을 나타냅니다. 예를 들어 Project Online의 경우 계획 5는 계획 3 보다 더 많은 기능을 제공 합니다.
...
이 섹션에 나와 있는 기능은 웹 데이터 저장소에 대 한 프로젝트의 데이터와 상호 작용 합니다. 이러한 모든 기능은 프로젝트 계획 1, 프로젝트 계획 3 및 프로젝트 계획 5에서는 모든 Microsoft Project 구독에서 사용할 수 있습니다.<br><br>

| 기능 | 설명 | Office 365 라이선스 | 요금제 1 | 계획 3 | 계획 5 |
|--------|-----------------------------|--------------|------------|------------|------------|
|**프로젝트, 작업 및 시간 관리**||||||
|보드 보기 | 기본 및 사용자 지정 작업 보드를 사용 하 여 워크플로 및 상태 모니터링을 개선 하기 위해 프로젝트 작업을 시각적으로 추적 합니다.| 보기 전용 | 예 | 예| 예|
|의존 | 작업 간의 종속성을 설정 하 고 시각적으로 추적 합니다.| 보기 전용 | 예 | 예| 예|
|표 보기 | 계층 눈금 작업 보기를 사용 하 여 프로젝트를 계획 및 관리 합니다. | 보기 전용 | 예 | 예 | 예 |
|시점과 | 중요 한 프로젝트 및 작업 마일스 톤을 설정 하 고 추적 합니다.|보기 전용 | 예 | 예 | 예 |
|프로젝트 홈 | 시작 및 종료 날짜와 자동화 된 일정을 사용 하 여 결과물을 추적 하 고 관리 합니다.| 예 | 예 | 예 | 예 |
|작업 예약 | 최근에 모니터링 해야 하는 중요 한 프로젝트 뿐 아니라 최근 작업 한 프로젝트를 눈으로 볼 수 있습니다.| 보기 전용 | 예 | 예 | 예 |
|시간 표시 막대 보기 (Gantt 차트) | 계층적 시간 표시 막대 보기에서 프로젝트 날짜, 종속성 및 배정을 시각적으로 추적 하 고 이해 합니다.|보기 전용 | 예 | 예 | 예 |
|요약 작업 | 요약 작업을 사용 하 여 결과물과 단계를 계획, 관리 및 추적 합니다.| 보기 전용 | 예 | 예 | 예 |
|작업 사용자 정의 필드 만들기 및 사용 | 프로젝트의 작업에 로컬 사용자 정의 필드를 추가 하거나, 이러한 필드에 데이터를 추가 하거나, 이러한 필드의 데이터를 업데이트 합니다.| 보기만 | 예 | 예 | 예 |
|**공동 작업** ||||||
|Microsoft 팀 통합 | Microsoft 팀에서 프로젝트에 대해 공동 작업을 수행 합니다. <sup>1</sup> | 예 | 예 | 예 | 예 |
|**리소스 및 프로그램 관리** ||||||
|프로젝트 팀 설치 | 구성원을 추가 및 제거 하 고 작업 달력을 설정 하 여 프로젝트 팀을 관리 합니다. | 아니요 | 예 | 예 | 예 |
|로드맵 | Microsoft Project Online, Microsoft Project for web 및 Azure 보드용 프로젝트 간에 시각적, 대화형 로드맵를 작성 합니다. <sup>2</sup> 프로젝트 계획 1을 사용 하 여 로드맵에 대 한 읽기 전용 액세스 권한을 갖습니다. 프로젝트 계획 3 또는 프로젝트 계획 5를 사용 하 여 로드맵를 만들 수도 있습니다. | 보기 전용 | 보기 전용 | 예 | 예 |
|**보고**<sup>3</sup> ||||||
|*Project에서 웹 데이터에 대 한* 보고서 읽기 | 기본 또는 사용자 지정 Power BI 보고서, 대시보드 및 포털을 보고 프로젝트, 프로그램, 포트폴리오 및 자원 데이터를 이해 합니다. | 아니요 | 아니요 | 예 | 예 |
|Project를 사용 하 여 *웹 데이터에 대 한* 보고서 만들기 | 기본 보고서를 기반으로 하는 사용자 지정 Power BI 보고서를 작성 하거나 처음부터 사용 하 여 조직에 중요 한 데이터를 이해 합니다.<br> 특정 조직의 요구 사항을 충족 하는 데 도움이 되는 사용자 지정 Power BI 대시보드 및 포털을 작성 합니다. | 아니요 | 아니요 | 예 | 예 |
|**편의성이** ||||||
|작성 | 관련자와 팀 구성원을 함께 사용 하 여 작업 목록, 프로젝트 일정 등을 동시에 작성, 편집 및 업데이트 합니다.| 보기 전용 | 예 | 예 | 예 |
|그래픽 표시기 | 그래픽 표시기를 통해 작업 상태, 배정 및 기타 사항을 이해 합니다.| 보기 전용 | 예 | 예 | 예 |
|**이동성** ||||||
|모바일 응용 프로그램 | PowerApps를 사용 하 여 사용자 지정 모바일 응용 프로그램을 작성 합니다. <sup>4</sup> |아니요 | 아니요 | 예 | 예 |
|**사용자 지정 및 통합**||||||
|기본 프로젝트 응용 프로그램 사용 | 기본 프로젝트 응용 프로그램을 사용 하 여 프로젝트를 보거나 새 프로젝트를 만들거나 프로젝트에 새 데이터를 추가 하거나 기존 프로젝트 데이터를 업데이트할 수 있습니다. | 보기만 | 예 | 예 | 예 |
|보기 및 양식 사용자 지정 <sup>4</sup> | 기본 프로젝트 응용 프로그램에서 보기와 양식만 사용자 지정 합니다. | 보기만 | 예 | 예 | 예 |
|사용자 지정 열 사용 | 테이블에 추가 된 열의 데이터를 보고, 추가 하 고, 업데이트 하거나, 삭제 합니다. | 보기만 | 보기만 | 예 | 예 |
|사용자 지정 표 <sup>5</sup> 사용 | 사용자 지정 테이블을 만들고 정의 하 여 프로젝트, 포트폴리오 등에 필요한 추가 데이터를 저장 합니다. | 아니요 | 보기만 | 예 | 예 |
|**보안 및 사용자 관리**||||||
|Office 최신 그룹 | 공동 작업을 수행 하 고 팀 구성원 들이 공유할 리소스 모음을 쉽게 설정할 수 있도록 프로젝트 팀을 구축 합니다. | 예 | 예 | 예 | 예 |
|**타사 앱**||||||
|타사 앱 <sup>4</sup> 를 사용 하 여 *웹에 대 한 프로젝트* 에 연결 | 사용자 지정 또는 타사 응용 프로그램을 사용 하 여 기본 또는 사용자 지정 프로젝트 테이블에서 프로젝트 데이터를 보거나, 만들거나, 업데이트 하거나, 삭제 합니다.<br> Project를 기반으로 하는 타사 응용 프로그램에서 웹 데이터에 대 한 보고서를 만듭니다. | 아니요 | 아니요 | 예 | 예 |

### <a name="project-online-features"></a>Project Online 기능

이 섹션에 나와 있는 기능은 Project Online SharePoint 데이터 저장소의 데이터와 상호 작용 합니다.<br><br>
...
|타임라인 | Project Web App을 사용 하 여 시간 표시 막대 보기에서 프로젝트 날짜, 종속성 및 할당을 시각적으로 추적 하 고 이해 합니다. | 예 | 예 |
...
|리소스 계약 (예약) | 프로젝트 관리자는 역할, 기술 또는 이름별로 자원에 대 한 요청을 제출할 수 있습니다. 리소스 관리자는 요청을 검토 하 고 가장 적합 한 리소스를 할당할 수 있습니다. |예<sup>8</sup> | 예<sup>9</sup> |
...
|Workflows | OData를 통한 비즈니스 프로세스 자동화 및 통합 (고급 자동화 기능 포함) <sup>7</sup> | 예 | 예 |
|Microsoft 365 통합 | 익숙한 Microsoft 도구 및 응용 프로그램을 사용 하 여 공동 작업, 문서 관리 등을 수행 합니다. <sup>1</sup> | 예 | 예 |
|Microsoft Planner 통합 | 프로젝트 작업을 Planner 계획에 연결 하 고 Planner에서 자세한 작업을 추적 합니다. <sup>1</sup> | 예 | 예 |
|**보안, 사용자 및 서비스 관리**||||
|Active Directory integration | 조직의 Active Directory 구성원 으로부터 팀을 구성 합니다. <sup>10</sup> | 예 | 예 |
...
<sup>3</sup> Power BI를 사용 하 여 웹 및 project Online 용 프로젝트에 대 한 보고를 사용할 수 있습니다. Power BI 라이선스가 필요 합니다.</br>
<sup>4</sup> 웹 또는 project Online 고객 데이터에 대 한 프로젝트에 액세스 하려면 별도의 전원 앱 구독을 필요로 하는 기본 프로젝트 응용 프로그램 외에 별도의 전원 앱을 작성 하 고 사용 해야 합니다.</br>
<sup>5</sup> 사용자 지정 테이블 5 개로 제한 됩니다.</br>
...
<sup>7</sup> 웹 데이터를 위한 project와 함께 비즈니스 프로세스의 자동화 및 통합 기능을 사용 하려면 power 자동화 구독 및 프로젝트 계획 3 또는 프로젝트 계획 5 구독이 필요 합니다.</br>
<sup>8</sup> 프로젝트 계획 3 또는 프로젝트 계획 5 구독을 사용 하는 사용자는 리소스 계약 요청을 제출할 수 있습니다. 자원 계약 요청을 검토 하거나, 수행 하거나, 승인할 수 없습니다.</br>
<sup>9</sup> 프로젝트 계획 5 구독을 사용 하는 사용자는 리소스 계약 요청을 검토, 수행 및 승인할 수 있습니다.</br>
<sup>10</sup> Active Directory에는 별도의 구독이 필요 합니다. </br>
...
|타임라인 | 시간 표시 막대 보기에서 프로젝트 날짜, 종속성 및 배정을 시각적으로 추적 하 고 이해 합니다. |
...
웹 프로젝트에는 다음 표에 설명 된 몇 가지 제한 사항이 있습니다.<br><br>

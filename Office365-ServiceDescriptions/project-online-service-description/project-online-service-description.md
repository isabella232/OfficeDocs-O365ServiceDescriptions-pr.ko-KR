...
|작업 사용자 정의 필드 만들기 및 사용 | 프로젝트의 작업에 로컬 사용자 정의 필드를 추가 하거나, 이러한 필드에 데이터를 추가 하거나, 이러한 필드의 데이터를 업데이트 합니다.| 아니요 | 예 | 예 | 예 |
|**공동 작업** ||||||
...
|보기 및 양식 사용자 지정 <sup>4</sup> | 기본 프로젝트 응용 프로그램에서 보기와 양식만 사용자 지정 합니다. | 아니요 | 예 | 예 | 예 |
|사용자 정의 필드 사용 | 사용자 정의 필드에서 데이터를 보고, 추가 하 고, 업데이트 하거나, 삭제 합니다. | 보기만 | 보기만 | 예 | 예 |
|사용자 지정 엔터티 <sup>5</sup> 사용 | 프로젝트, 프로그램, 포트폴리오 등에 필요한 추가 데이터를 저장할 사용자 지정 엔터티를 만들고 정의 합니다. | 아니요 | 보기만 | 예 | 예 |
|**보안 및 사용자 관리**||||||
|Office 최신 그룹 | 공동 작업을 수행 하 고 팀 구성원 들이 공유할 리소스 모음을 쉽게 설정할 수 있도록 프로젝트 팀을 구축 합니다. | 예 | 예 | 예 | 예 |
|**타사 앱**||||||
|타사 앱 <sup>4</sup> 를 사용 하 여 *웹에 대 한 프로젝트* 에 연결 | 사용자 지정 또는 타사 응용 프로그램을 사용 하 여 기본 또는 사용자 지정 프로젝트 엔터티에서 프로젝트 데이터를 보거나, 만들거나, 업데이트 하거나, 삭제할 수 있습니다.<br> Project를 기반으로 하는 타사 응용 프로그램에서 웹 데이터에 대 한 보고서를 만듭니다. | 아니요 | 아니요 | 예 | 예 |
...
<sup>5</sup> 사용자 지정 엔터티로 제한 됩니다.</br>

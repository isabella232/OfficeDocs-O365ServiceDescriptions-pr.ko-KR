...
|**리소스 및 프로그램 관리** ||||||
|프로젝트 팀 설치 | 구성원을 추가 및 제거 하 고 작업 달력을 설정 하 여 프로젝트 팀을 관리 합니다. | 아니오 | 예 | 예 | 예 |
...
|**보고**<sup>3</sup> ||||||
|기본 보고 기능 | 미리 작성 된 보고서를 사용 하 여 프로젝트, 프로그램, 포트폴리오 및 자원 데이터를 이해 합니다. | 아니오 | 예 | 예 | 예 |
|사용자 지정 보고서 | 기본 보고서를 기반으로 사용자 지정 보고서를 작성 하거나 처음부터 사용 하 여 조직에서 중요 한 데이터를 이해 합니다. | 아니오 | 예 | 예 | 예 |
|대시보드 및 포털 | 특정 조직 요구 사항을 충족 하는 데 도움이 되는 사용자 지정 대시보드 및 포털을 작성 합니다.| 아니오 | 예 | 예 | 예 |
|**편의성이** ||||||

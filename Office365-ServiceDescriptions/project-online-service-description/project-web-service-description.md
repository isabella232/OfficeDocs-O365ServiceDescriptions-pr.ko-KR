...
Project 웹용 웹 사이트는 Project 플랜 1, Project 플랜 3 및 Project 플랜 5. 웹 기능에 [Project](/office365/servicedescriptions/project-online-service-description/project-online-service-description#project-for-the-web-features) 나열된 기능은 웹 데이터 저장소에 대한 Project 데이터와만 상호 작용합니다. 사용자가 웹용 구독을 사용하도록 설정하는 Microsoft Project 자세한 내용은 프로젝트 관리 솔루션 및 비용 [비교를 참조하세요.](https://www.microsoft.com/microsoft-365/project/compare-microsoft-project-management-software)
...
마지막 Project 플랜 1, Project 플랜 3 또는 Project 플랜 5 구독이 만료되면 Microsoft Dataverse를 사용하는 활성 구독이 없는 Project 웹 인스턴스에 대한 구독이 자동으로 삭제되지 않습니다. 웹 Project 구독의 경우 Microsoft Dataverse를 사용하는 활성 구독이 없는 한 평가판 인스턴스가 삭제되지 않습니다.
...
[Project 아키텍처 다이어그램은](/project-for-the-web/project-architecture-overview) 웹용 Project Power Platform, Power BI 및 타사 서비스에서 작동하는 방법을 보여줍니다. 로드맵(포트폴리오 서비스)은 기본 환경에만 설치되는 반면 로드맵은 기본 앱이 지원되는 모든 환경에서 Project 수 있습니다. 이 Project 솔루션은 기본, 프로덕션 및 샌드박스 Dataverse 환경에 설치할 수 있습니다.
...
Project 로드맵을 사용하려면 Power Automate 구독의 일부로 프로비전되는 Project 필요합니다. Power Automate 함께 제공하는 Project 기능은 Flow 앱 섹션의 Project 서비스 **** 계획에 대한    ****   Microsoft 365 관리 센터.
...
Dataverse 저장소 용량을 Project 추가 Microsoft 구독이 있습니다. 다른 Dataverse 저장소 용량 권리에 대한 자세한 내용은 [Dynamics 365](https://go.microsoft.com/fwlink/?LinkId=866544&clcid=0x409)라이선스 가이드 및 Power Apps, Power Automate 및 Power Virtual Agents   라이선스 [가이드를 참조하세요.](https://go.microsoft.com/fwlink/?LinkId=2085130&clcid=0x409)

### <a name="data-backup-and-retention"></a>데이터 백업 및 보존

Project 웹용 데이터 백업 및 보존 정책은 Office 365. 자세한 내용은 에서 데이터 보존, 삭제 [및 폐기 Microsoft 365.](/office365/Enterprise/office-365-data-retention-deletion-and-destruction-overview) 백업 및 복원을 관리하는 방법에 대한 자세한 내용은 [Back up and restore environments을 참조하십시오.](/power-platform/admin/backup-restore-environments) 기본 환경은 삭제할 수 없습니다. 백업 및 복원을 지원하지 않습니다. 환경에 대한 자세한 내용은 기본 환경 [을 참조하세요.](/power-platform/admin/environments-overview#the-default-environment)

### <a name="data-encryption"></a>데이터 암호화

웹용 웹 응용 Project 암호화에 대한 자세한 내용은 [Microsoft Dynamics 365의 암호화를 참조하세요.](/microsoft-365/compliance/office-365-encryption-in-microsoft-dynamics-365)

### <a name="project-for-the-web-boundaries-and-limitations"></a>Project 경계 및 제한에 대한 자세한 사항

다음 표에서는 웹용 Project 제한 사항을 설명합니다.
...
- [Project 관리자를 위한 웹 시작 가이드 - 웹 Project 대한 | Microsoft Docs](/project-for-the-web/project-for-the-web-get-started-guide-for-admins)
- 모범 사례, 뉴스 및 추세는 Project [블로그로 이동하세요.](https://techcommunity.microsoft.com/t5/project-blog/bg-p/ProjectBlog)

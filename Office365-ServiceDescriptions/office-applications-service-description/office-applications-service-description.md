...
다음 표를 사용하여 Microsoft Office 2013 및 Office 2016의 볼륨 라이선스 버전과 계획의 기능 가용성을 비교합니다.
...
|SharePoint Server, SharePoint Online, 비즈니스용 OneDrive 및 Microsoft 365의 전자 필기장에 대한 OneNote 클라이언트 액세스  <br/> |예  <br/> |예  <br/> |예<sup>++</sup> <br/> |예 <br/> |예  <br/> |아니요  <br/> |예  <br/> |예 <br/> |아니요  <br/> |예  <br/>|예  <br/> |아니요  <br/> |
...
><sup>++</sup> SharePoint Server, SharePoint Online, 비즈니스용 OneDrive 및 Office 365의 전자 필기장에 대한 OneNote 앱 액세스 <br/>
...
<sup>9</sup> Office 365 E3 및 엔터프라이즈용 Microsoft 365 앱에 대한 볼륨 정품 인증은 Windows Server 2008 R2 이상에서 RDS 역할이 활성화되거나 Windows To Go 설치로 제한됩니다. 어느 경우든 이러한 설치에 액세스하는 사용자는 Office 365 E3 또는 엔터프라이즈용 Microsoft 365 앱의 사용이 허가된 사용자로 설정해야 합니다.<br/> 
Office 365 F3의 비즈니스용 <sup>Skype</sup> 기능에는 비즈니스용 Skype 플랜 1이 포함되어 있습니다(데스크톱 공유 없음, 앱 공유 없음, 다중 사용자 오디오, 비디오 또는 웹 회의를 시작할 수 없음, 모임을 예약할 수 없음).<br/> 
<sup>11</sup> 현재 지연 채널에 대한 대상 릴리스 또는 현재 채널에 있는 경우 액세스를 사용할 수 있습니다. 지연 채널에 있는 경우 2017년 6월에 Access가 제공될 예정입니다. 자세한 내용은 [Microsoft 365 및 Office 365 구독의](https://support.office.com/article/Access-included-as-part-of-Office-365-Business-and-Business-Premium-f55c8362-5816-4f8b-897d-0a05e7ba0fef)일부로 포함된 액세스를 참조하세요.<br/> 
<sup>12</sup> Infopath 2013은 여전히 지원되지만 Office Professional Plus 2016 설치에 제공되지만 Office 2016의 새 버전은 없습니다.<br/> 
<sup>13</sup> 10.1인치 이하의 통합 화면이 있는 디바이스로 제한됩니다.<br/> 
<sup>14</sup> Power Query는 Excel용 Microsoft Power Query에서 다운로드할 수 있는 무료 추가 [기능입니다.](https://www.microsoft.com/download/details.aspx?id=39379) 사용하도록 설정하면 리본 메뉴의 파워 쿼리 탭에서 파워 쿼리 기능을 사용할 수 있습니다.<br/> 
...
|외부 공유 |예 | 아니요 | 아니요 |
|**[Microsoft OneNote는](office-applications.md#microsoft-onenote)** 정부 클라우드에서 완전히 사용할 수 있습니다. 단, 현재는 다음과 같은 기능을 사용할 수 없습니다.| 예 | 예 | 예 |
|리서치 도구 | 아니요 | 아니요 | 아니요 |
|지능형 디지털 Ink | 아니요 | 아니요 | 아니요 |
|**[Microsoft Outlook은](office-applications.md#microsoft-outlook)** 정부 클라우드에서 완전히 사용할 수 있습니다. 단, 현재는 다음과 같은 기능을 사용할 수 없습니다.| 예 | 예 | 예 |
|Office 소리(일부) | 아니요 | 아니요 | 아니요 |
|DDE는 기본적으로 사용하지 않도록 설정되어 있습니다.  | 아니요 | 아니요 | 아니요 |
|받아쓰기 | 아니요<sup>1</sup> | 아니요<sup>1</sup> | 아니요<sup>1</sup> |
|**[Microsoft PowerPoint는](office-applications.md#microsoft-powerpoint)** 정부 클라우드에서 완전히 사용할 수 있습니다. 단, 현재는 다음과 같은 기능을 사용할 수 없습니다.| 예 | 예 | 예 |
|스마트 조회 | 아니요 | 아니요 | 아니요 |
|Office 소리(일부) | 아니요 | 아니요 | 아니요 |
|3D 모델 및 3D 포함 애니메이션 | 아니요 | 아니요 | 아니요 |
|차트: maps | 아니요 | 아니요 | 아니요 |
|지능형 디지털 Ink | 아니요 | 아니요 | 아니요 |
|PowerPoint의 & 자막이 있는 라이브 캡션 | 아니요 | 아니요 | 아니요 |
|발표자 코치 | 아니요 | 아니요 | 아니요 |
|Shared with Me| 아니요 | 아니요 | 아니요 |
...
|**[Microsoft Word는](office-applications.md#microsoft-word)** 정부 클라우드에서 완전히 사용할 수 있습니다. 단, 현재는 다음과 같은 기능을 사용할 수 없습니다.| 예 | 예 | 예 |
|스마트 조회 | 아니요 | 아니요 | 아니요 |
|리서치 도구 | 아니요 | 아니요 | 아니요 |
...
> <sup>2</sup> 로컬 Surface Hub에서 사용할 수 있습니다(로그인되지 않은 경우).

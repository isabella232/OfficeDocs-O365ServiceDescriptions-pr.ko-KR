...
<sup>9</sup> Office 365 E3 및 엔터프라이즈용 Microsoft 365 앱 볼륨 정품 인증은 Windows Server 2008 R2 이상에서 RDS 역할을 사용하도록 설정하거나 Windows To Go 설치로 제한됩니다. 어느 경우든 이러한 설치에 액세스하는 사용자는 사용이 허가된 사용자 또는 Office 365 E3 엔터프라이즈용 Microsoft 365 앱.<br/> 

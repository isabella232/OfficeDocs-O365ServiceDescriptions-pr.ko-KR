...
비디오 및 오디오 콘텐츠는 읽기용 보기 및 슬라이드 쇼에서 재생되며 파일 크기를 100MB로 제한합니다. 온라인 비디오는 YouTube에서 삽입할 수 있으며 미디어 컨트롤은 YouTube에서 이동 및 삭제할 수 웹용 PowerPoint. 그러나 YouTube 이외의 오디오 및 비디오를 삽입하려면 Microsoft PowerPoint 데스크톱 앱이 필요합니다.

...
Microsoft는 미국, 대한민국 공공 분야의 발전 하며 고유한 요구 사항에 대 한 응답으로 Office 365 미국 정부 계획 (또는 "Office 365 미국 정부 기관의")을 만들었습니다. 이 섹션에서는 Office 365 미국 정부 기관에 관련 된 기능에 대 한 개요를 제공 합니다. [Office 365 서비스 설명 ](../../office-365-service-descriptions-technet-library.md)와 함께 보충이 섹션을 읽고 것이 좋습니다.
...
## <a name="about-office-365-us-government-environments"></a>Office 365 미국 정부 환경에 대 한
<a name="BM1_About"> </a>

Office 365 Government 요금제는 월별 구독으로 제공되고 사용자 수에 제한 없이 사용을 허가할 수 있습니다. 
  
- **Office 365 GCC** 환경 FedRAMP 보통 수준의 포함 하 여 클라우드 서비스에 대 한 연방 요구 사항 및 범죄자 정 및 연방 세금 정보 시스템 (CJI 및 FTI 데이터 형식)에 대 한 요구 사항에 대 한 준수를 제공 합니다. 
    
- **Office 365 높은 GCC 및 DoD** 환경 팔 규정 (ITAR)에서 부서의 방어 보안 요구 사항 지침, 방어 연방 취득 규정 보완 정보 (DFARS), 및 국제 트래픽을 준수를 제공합니다. 
...
Office 365 미국 정부 (1) 미국 연방, 상태, 로컬, 부족을 사용할 수 없으며 사진을 정부 엔터티 및 정부 규정 및 요구 사항에 따라 달라 집니다 된 데이터를 처리 하 고 있는 Office 365 미국 정부를 활용 하는 (2) 다른 엔터티는 적절 한 자격의 유효성 검사에 따라 달라 집니다 이러한 요구 사항을 충족 합니다. Microsoft에서 자격의 유효성을 검사할 국제 트래픽을에서 팔 규정 (ITAR), f b I의 범죄자 정의 정보 서비스 (CJIS) 정책 또는 기타 적용 법률 적용 데이터에 따라 달라 집니다 데이터를 처리 하는 포함 됩니다. 정부 규제 된 또는 제어 된 데이터입니다. 유효성 검사는 데이터의 처리에 대 한 특정 요구 사항을 정부 기관 후원 또는 ITAR 데이터에 대 한 미국 상태 부서와 등록 증명이 필요할 수 있습니다. Office 365 DoD 환경은 미국, 대한민국 방어 부서의 단독 사용 합니다.
  
자격 기준은 Office 365 미국 정부 제품 전체에서 일관 된, Microsoft GCC 높은 환경에 대 한 DFARS 및 ITAR 계약 언어에만 동의 됩니다.
...
Office 365<sup>1</sup>에 대 한 FastTrack 센터 복리 후생와 원격으로 사용 하 여 작업할 준비 하기 위해 Office 365 환경을 사용 하 고 계획 롤아웃 및 조직 내에서 사용 현황에 대 한 FastTrack 전문가입니다. FastTrack 프로세스 온 보 딩 및 사용자 채택 서비스를 제공합니다. 
  
온보딩은 다음으로 구성되어 있습니다.
  
- 핵심 온 보 딩-이러한 파일은 필요한 경우 테 넌 트 구성 및 Azure Active Directory (Azure AD)와 통합에 필요한 작업입니다. 또한 핵심 온 보 딩 기준선 다른 가능한 서비스 온 보 딩에 대 한 제공합니다.
    
- 서비스 온 보 딩 및 마이그레이션-서비스 온 보 딩 작업 테 넌 트의 시나리오를 사용 합니다. 데이터 마이그레이션 (전자 메일 및 파일 포함) [데이터 마이그레이션](https://aka.ms/whatcanmigrate)에서 다룹니다. <sup>2</sup>
    
사용자 채택 서비스는 사용자가 적합한 서비스를 인식하고 비즈니스 가치를 창출하는 데 사용할 수 있는 지침을 제공하는 작업으로 구성됩니다. 이 지원은 온보딩 활동과 동시에 이루어집니다.
  
FastTrack 센터 프로세스에 대 한 정보를 찾을 수 [여기](https://aka.ms/whatistheprocess)합니다. 계약 역할 및 책임을 분석 하 여, [사용자의 책임](https://aka.ms/whatdowedo)뿐아니라 [FastTrack 책임](https://aka.ms/whatdoesftcdo) 을 검토 하십시오.
  
<sup>1</sup> 수신 FastTrack 서비스를 [사용할 수 있는 계획](https://aka.ms/whocanbenefit) 의 목록에서 최소 50 라이선스를 구입 해야 합니다. 
  
<sup>2</sup> 데이터 마이그레이션 서비스는 500 명 이상의 라이선스와 Office 365 테 넌 트에 사용할 수 있습니다. 
  
## <a name="data-migrations-performed-by-fasttrack"></a>FastTrack 하 여 수행 하는 데이터 마이그레이션
<a name="BM5-Restricted"> </a>

[FastTrack](https://fasttrack.microsoft.com/) 마이그레이션 혜택을 선택 하는 고객은 자신의 데이터 마이그레이션 관리 팀에 대 한 액세스 권한을 부여 해야 합니다. 이러한 담당자 미국 시민 되며 Office 365 미국 정부 서비스의 고객을 위한 마이그레이션을 수행 하기 전에 다음과 같은 배경 검사를 거쳐야 합니다. 
...
## <a name="security-amp-compliance-center"></a>보안 &amp; 준수 센터
<a name="BM9-Requirements"> </a>

보안에 대 한 내용은 &amp; 준수 센터 및 추가 정보 및 가용성에 대 한 링크를 참조 [Office 365 보안 &amp; 준수 센터](../../office-365-platform-service-description/office-365-securitycompliance-center.md)합니다.
...
|전화 단계 인증  <br/> |<sup>9</sup> 예 <br/> |<sup>9</sup> 예 <br/> |예  <br/> |<sup>9</sup> 예 <br/> |
|Office 365 데스크톱 설정  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |
|Office 365로 사용자 관리  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |
|.csv 파일을 사용한 대량 업로드  <br/> |<sup>9</sup> 예 <br/> |<sup>9</sup> 예 <br/> |예  <br/> |<sup>9</sup> 예 <br/> |
...
|사서함 사용량  <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |
|사서함 연결 유형  <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |
|보낸 메일 및 받은 메일  <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |
|상위 보낸 사람 및 받는 사람  <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |
|스팸 감지  <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |
|맬웨어 감지  <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |
|메일에 대한 상위 맬웨어  <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |
|메일에 대한 규칙 일치  <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |
|메일에 대한 상위 규칙 일치  <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |
|메일에 대한 상위 DLP 정책 일치  <br/> |아니요  <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |
|메일에 대한 심각도별 DLP 정책 일치  <br/> |아니요  <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |
|메일에 대한 DLP 정책 일치, 재정의 및 가양성  <br/> |아니요  <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |
|메일에 대한 상위 DLP 규칙 일치  <br/> |아니요  <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |
|IM 및 오디오 세션  <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |
|응용 프로그램 공유, 웹 및 전화 접속 회의  <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |
|비디오, 응용 프로그램 공유 및 파일 전송 세션  <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |
|IM 및 오디오/비디오 회의  <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |
|다운로드 가능한 메일 보호 보고서  <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |<sup>15</sup> 예 <br/> |
...
> <sup>1</sup> azure 정보 보호는 포함 되어있지 않지만 별도 추가 기능으로 구입할 수 있습니다 및 지원 되는 정보 권한 관리 (IRM) 기능을 사용 하는 합니다. 일부 Azure 정보 보호 기능을 사용 하는 Office 365 미국 정부 G1 또는 Office 365 미국 정부 f 1에 포함 되지 않은 Office 365 ProPlus에 대 한 구독을 해야 합니다. ><br/><sup>2</sup> 기존 BBCS 및 BIS 고객 서비스 사용을 계속할 수 있습니다. 새 고객에 게 허용 되지 않습니다.<br/><sup>3</sup> 디렉터리 동기화를 사용할 경우 계정을 삭제 하거나 해야 하는 대신 Office 365 포털 또는 Windows PowerShell 용 Azure Active Directory 모듈을 사용 하 여 Active Directory를 사용 하 여 암호를 변경 합니다. 
<br/><sup>4</sup> 암호 동기화를 사용 하는 경우 사용자는 로컬 Active Directory에서 암호를 변경 해야 합니다. 
<br/><sup>5</sup> 사용자에 대 한 셀프서비스 암호 관리 정책을 설정 하는 방법을 알아보려면 [Azure AD에 대 한 암호 관리](https://azure.microsoft.com/en-us/documentation/articles/active-directory-manage-passwords/)를 참조 합니다. <br/><sup>6</sup> Office 365의 이전 버전에서 업그레이드 했을 때 하지 않았다면 Office 365와 공용 웹사이트를 하나만 가질 수 있습니다. 이 경우 두 공용 웹사이트 되었지만 사용자 지정 도메인 이름으로 그 중 하나만 호스팅할 수 있습니다. 비즈니스 구독에 대 한 두 웹사이트를 사용 하는 방법에 대 한 자세한 내용은 [두 Office 365 공용 웹사이트와 함께 작동](https://go.microsoft.com/fwlink/p/?LinkID=271589)을 참조 하십시오. 다른 구독을 설치한 경우 [파트너 웹사이트를 호스트 하 고 Office 365의 공용 웹사이트에 대 한 설명](https://go.microsoft.com/fwlink/p/?LinkID=325009)에서 공용 웹사이트에 대해 알아봅니다.<br/><sup>7</sup> 용어 할인 된를 구매한 단축 시트는 초기 종료 요금 적용 될 수 있습니다. 월별로 유료 구독에 적용 되지 않습니다.<br/><sup>8</sup> 다음 계획 Office 365 관리 센터에서 라이선스 명 변경 내용을 지원 하지 않는: > Office 365 미국 정부 G1 > Office 365 미국 정부 G3 > Office 365 미국 정부 K1 <br/><sup>9</sup> 아직 사용할 수 있는 GCC 높은 하지만 곧 제공 될 예정입니다.
<br/><sup>10</sup> Office 365 미국 정부 G1, G3 및 F1 키를 대상 버전 및 비즈니스 로드맵에 대 한 Office 365 적용 합니다. 그러나 일부 차이점 또는 [규정 준수 요구 사항](https://products.office.com/en-us/business/office-365-trust-center-cloud-computing-security?legRedir=true&amp;CorrelationId=eeaccba9-85ea-4fa8-9c84-3fb4c9e1547b&amp;tab=7a3a6365-14c0-81ac-34ff-f4a416599263)으로 인해 특정 서비스 업데이트에 대 한 지연 있을 수 있습니다.

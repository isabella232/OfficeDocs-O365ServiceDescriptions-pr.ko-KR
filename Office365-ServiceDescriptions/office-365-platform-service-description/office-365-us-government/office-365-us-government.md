...
- Office 365 GCC  환경은 FedRAMP High, DFARS(Defense Federal Acquisition Regulations Supplement) 및 범죄 사법 및 연방 세금 정보 시스템(CJI 및 FTI 데이터 형식)에 대한 요구 사항을 포함하여 클라우드 서비스에 대한 연방 요구 사항을 준수합니다.
...
|Azure Information Protection을 사용하여 콘텐츠 보호|아니요<sup>1</sup>|예<sup>15</sup>|예<sup>15</sup>|예<sup>15</sup>|
...
|계정 삭제 및 사용자 암호 Microsoft 365 또는 Windows PowerShell<sup>3을</sup> 사용하여 다시 설정|예|예|예|예|
...
|기본 감사<sup>23</sup>|예|예|예|예|
|고급 감사<sup>23</sup>|아니요|아니요|예|아니요|
|Microsoft 보안 점수<sup>14</sup>|예<sup>9, 15</sup>|예<sup>9, 15</sup>|예<sup>9, 15</sup>|예<sup>9, 15</sup>|
...
<br/><sup>12</sup> 에서 사용할 수 [https://securescore.office.com](https://securescore.office.com) 있습니다. 관리자 권한이 있어야 합니다. 자세한 내용은 Microsoft 보안 점수를 [참조하세요.](/microsoft-365/security/mtp/microsoft-secure-score)
<br/><sup>13</sup> DoD 환경에서는 아직 사용할 수 없지만 곧 제공될 예정입니다.
<br/><sup>14</sup> 관리 센터는 DoD 또는 고급 환경의 사용 현황 GCC 포함되어 있지 않습니다.
...
|Microsoft Forms<sup>7</sup>|예|예|예|아니요|

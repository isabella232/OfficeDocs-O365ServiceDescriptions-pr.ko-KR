...
Office 365 Germany는 유럽에서 이미 사용 가능한 Office 365 서비스와는 다른 옵션입니다. 독일, 유럽 연합(EU) 및 EFTA(유럽 자유 무역 연합)에서 독일의 데이터 상주와 엄격한 데이터 수탁자 모델을 통해 독일 데이터 센터에서 디지털 작업을 위한 업계 최고의 생산성 서비스를 제공하면 독일, 유럽 연합(EU) 및 유럽 자유 무역 연합(EFTA)에서 가장 규제된 고객의 요구를 충족할 수 있습니다.
...
고객의 요구에 이 변화에 따라 독일의 클라우드 전략은 글로벌 클라우드 제공과 일관된 독일의 새 클라우드 지역 전달에 중점을 낼 것입니다. 이 중점적으로 Microsoft는 더 이상 신규 고객을 수락하거나 현재 사용 가능한 Microsoft 클라우드 독일에서 새 서비스를 배포하지 않습니다. 기존 고객은 현재 사용 가능한 현재 클라우드 서비스를 계속 사용할 수 있습니다. 이 서비스는 필요한 보안 업데이트로 유지 관리합니다. [Office 365 Germany에 대해 자세히 알아보습니다.](https://support.office.com/article/8a5a4bbc-667a-4cac-8769-d8ac9015db4c)
...
|웹용 Visio <sup>4</sup>|예|예|예|예|예|예|예|예|
...
> [!NOTE]
> 사용자 및 도메인을 설정할 수 있는 Microsoft 365 관리 센터를 비롯한 관련 기능이 있는 클라우드 기반 구독 서비스 <sup>1개</sup> <br/>
<sup>2</sup>Office 365 ProPlus 계획을 별도로 구매할 수 있으며 Office 365 ProPlus는 Office 365 Germany Enterprise E3 및 Office 365 Germany Enterprise E4에 포함되어 있습니다. 최신 인증을 Office 365 Germany에서 사용하도록 설정해야 합니다. [Office](https://support.office.com/article/modern-authentication-be-enabled-776c0036-66fd-41cb-8928-5495c0f9168a) 365 Germany에서 사용할 수 있는 최신 인증을 사용하도록 설정해야 합니다. <br/>
<sup>3</sup> Project Online 및 Power BI는 포함되어 있지 않지만 별도의 추가 기능 서비스로 구입하거나 Office 365 Germany Education A1 요금제에 무료로 추가할 수 있습니다. <br/>
<sup>웹용</sup> Visio 4개(보기 기능)를 무료로 사용할 수 있습니다. 웹용 Visio에서 만들기 및 편집 기능을 사용하려면 라이선스가 필요합니다. 웹용 Visio에 대한 자세한 내용은 [Visio에서](../visio-online-service-description/visio-online-service-description.md)웹 서비스 설명을 참조하십시오.
...
보안 준수 &amp; 센터는 Office 365 Germany에서 사용할 수 있습니다. 자세한 정보 및 기능 목록은 [Office 365 보안 준수 &amp; 센터를 참조하세요.](office-365-securitycompliance-center.md)

### <a name="what-compliance-certificates-are-provided-for-office-365-germany"></a>Office 365 Germany에 대해 제공되는 준수 인증서는 무엇입니까?

Office 365 Germany는 Office 365의 클라우드 보안 및 규정 준수 표준을 준수합니다. Office 365는 SOC(서비스 조직 제어), ISO(국제 표준화 기구) 및 감사의 일부로 공인된 감사자에 의해 독립적으로 평가된 포괄적인 인증 집합을 제공합니다. 이 인증에는 ISO 27001/27002, 27017, 27018 및 SOC 1 및 2가 포함됩니다. The additional data trustee controls in Office 365 Germany will be evaluated by independent assessors as part of our annual ISO and SOC audits.
...
|Microsoft 365 관리 센터를 사용하여 Office 365 관리 Windows PowerShell|예|예|예|예|예|예|예|예|
|Azure Information Protection을 사용하여 콘텐츠 보호|<sup>아니요 2</sup>|<sup>아니요 2</sup>|<sup>아니요 2</sup>|<sup>아니요 2</sup>|<sup>아니요 2</sup>|아니요|아니요|<sup>아니요 2</sup>|
...
|Microsoft Power Automate|아니요|아니요|아니요|아니요|아니요|아니요|아니요|아니요|
...
|전자 **name.onmicrosoft.de** Skype Online <sup>8에</sup> 사용자 지정 도메인 또는 사용자 지정 도메인 이름 사용|예|예|예|예|예|예|예|예|
|팀 사이트에 **name.sharepoint.de** 사용|예|예|예|예|예|예|예|예|
|팀 사이트에 사용자 지정 도메인 이름<sup>사용 7</sup>|아니요|아니요|아니요|아니요|아니요|아니요|아니요|아니요|
...
|Microsoft 365 관리 센터 대시보드에서 사용할 수 있는 개별 경고 상태|예|예|예|예|예|예|예|예|
...
|Microsoft 365 보고 웹 서비스를 사용하여 자체 보고서 만들기|예|예|예|예|예|예|예|예|
...
> [!NOTE]
> <sup>1</sup> Office 365 Germany는 제조업체에서 지원하지 않는 운영 체제를 지원하지 않습니다.<br/>
<sup>2</sup> Azure Information Protection은 포함되어 있지 않지만 별도의 추가 기능으로 구입할 수 있으며 지원되는 IRM(정보 권한 관리) 기능을 사용하도록 설정할 수 있습니다. 일부 Azure Information Protection 기능을 사용하려면 Office 365 Germany Business Essentials, Office 365 Germany Business Premium, Office 365 Germany Enterprise E1, Office 365 Germany Education A1 또는 Office 365 Germany Enterprise K1에 포함되지 않은 Office 365 ProPlus 구독이 필요합니다.<br/>
...
<sup>6</sup> Office 365 Germany Education A1 요금제는 Microsoft 365 관리 센터의 라이선스 사용자 수 변경을 지원하지 않습니다.<br/>
<sup>7</sup> 일부 Office 365 Germany 계획에는 Office 365 ProPlus Office 2016 및 Office 2013과 같은 클라이언트 소프트웨어 응용 프로그램을 사용할 수 있는 권리가 포함되어 있습니다. Client software applications run on an end user's device rather than in data centers in Germany. For purposes of your agreement with Microsoft, client software applications are not [German Online Services](https://microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&amp;DocumentTypeId=58). 또한 클라이언트 소프트웨어 응용 프로그램은 최종 사용자가 독일어 온라인 서비스가 아닌 온라인 서비스에 액세스하는 데도 사용됩니다. German data residency commitments and access control by the German data trustee apply only to the German Online Services.<br/>
<sup>8 최신</sup> [인증은](https://support.office.com/article/modern-authentication-be-enabled-776c0036-66fd-41cb-8928-5495c0f9168a) Office 365 Germany에서 사용할 수 있어야 합니다.<br/>
<sup>9</sup> Office 365 Germany는 Office 365의 클라우드 보안 및 규정 준수 표준을 준수하도록 구축되었습니다. Office 365 offers a comprehensive set of certifications, independently assessed by accredited auditors as part of SOC, ISO and audits. The certifications include ISO 27001/27002, 27017, 27018 and SOC 1 &amp; 2 certification. The additional data trustee controls in Office 365 Germany will be evaluated by independent assessors as part of our annual ISO and SOC audits.

## <a name="office-application-features"></a>Office 응용 프로그램 기능  

> [!NOTE]
> Office 365 Germany 계획에는 최종 사용자의 장치에서 설치 및 실행되는 Office 365 ProPlus, Office 2013\* 및 Office 2016과 같은 클라이언트 소프트웨어 응용 프로그램이 포함됩니다. 클라이언트 소프트웨어 응용 프로그램은 독일 데이터 센터에서만 작동하지는 않습니다. 최종 사용자가 독일어 온라인 서비스가 아닌 온라인 서비스에 액세스할 [수 있습니다.](https://microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&amp;DocumentTypeId=58) Microsoft와의 계약을 위해 클라이언트 소프트웨어 응용 프로그램은 독일어 온라인 서비스가 아닙니다. 독일어 데이터 트러스티에 의한 액세스 제어 및 독일어 데이터 상주 약정은 독일어 온라인 서비스에만 적용됩니다.<br/> \*Office 365 Germany용 Office 2013을 사용하려면 [최신 인증이 사용되도록 설정되어야 합니다](https://support.office.com/article/776c0036-66fd-41cb-8928-5495c0f9168a).

다음 표를 사용하여 Office 365 Germany 계획 간의 기능을 비교해 볼 수 있습니다.<br><br>

| 기능 | Office 365 Germany Business | Office 365 Germany Business Essentials | Office 365 Germany Business Premium | Office 365 Germany Education A1 | Office 365 Germany Enterprise E1 | Office 365 Germany Enterprise E3<sup>9</sup> | Office 365 Germany Enterprise E4 | Office 365 Germany Enterprise K1 |
|:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
...
|[Windows Phone용 Office Mobile](../office-applications-service-description/office-applications.md#office-mobile-for-windows-phone)|예|아니요|예|아니요<sup>7</sup>|아니요|예|예|아니요|
|Android<sup>11용</sup> Outlook|아니요|아니요|아니요|아니요<sup>7</sup>|아니요|아니요|아니요|아니요|
|**엔터프라이즈 값**|**Office 365 Germany Business**|**Office 365 Germany Business Essentials**|**Office 365 Germany Business Premium**|**Office 365 Germany Education A1**|**Office 365 Germany Enterprise E1**|**Office 365 Germany Enterprise E3**|**Office 365 Germany Enterprise E4**|**Office 365 Germany Enterprise K1**|
...
|Windows Server AD RMS<sup>4를</sup> 사용한 정보 권한 관리|아니요|아니요|아니요|아니요|아니요|아니요|아니요|아니요|
...
> [!NOTE]
> <sup>1</sup> Office 365 Germany 계획에는 Office 365 ProPlus, Office 2013 및 Office 2016과 같은 최종 사용자의 디바이스("클라이언트 소프트웨어 응용 프로그램")에서 설치 및 실행되는 클라이언트 소프트웨어 응용 프로그램이 포함됩니다. 클라이언트 소프트웨어 응용 프로그램은 독일 데이터 센터에서만 작동하지는 않습니다. 최종 사용자가 독일어 온라인 서비스가 아닌 온라인 서비스에 액세스할 수 있습니다. Microsoft와의 계약을 위해 클라이언트 소프트웨어 응용 프로그램은 독일어 온라인 서비스가 아닙니다. 독일어 데이터 트러스티에 의한 액세스 제어 및 독일어 데이터 상주 약정은 독일어 온라인 서비스에만 적용됩니다.<br/>
...
<sup>3</sup> Azure Information Protection은 포함되어 있지 않지만 지원되는 IRM 기능을 사용하도록 설정하기 위해 별도의 추가 기능으로 구입할 수 있습니다.<br/>
...
현재 채널 또는 지연 채널의 대상이 지정한 릴리스에 있는 경우 <sup>10</sup> 액세스가 현재 제공됩니다. 지연 채널에 있는 경우 2017년 6월에 Access가 제공될 예정입니다. 자세한 내용은 [Office 365 Business 및 Business Premium의 일부로 포함된 Access](https://support.office.com/article/f55c8362-5816-4f8b-897d-0a05e7ba0fef).<br/>
<sup>11</sup> Office 365 Germany에서는 사용할 수 없지만 곧 제공될 예정입니다.
...
|[Windows Phone용 Office Mobile](../office-applications-service-description/office-applications.md#office-mobile-for-windows-phone)|아니요|예|예|
|Android<sup>11용</sup> Outlook|아니요|아니요|아니요|
|**엔터프라이즈 값**|**Office Professional Plus 2013**|**Office Professional Plus 2016**|**Office 365 ProPlus**|
...
|그룹 정책 지원|예|예|예|
|Azure Information Protection<sup>4를</sup> 사용한 정보 권한 관리|아니요|아니요|아니요|
|Windows Server AD RMS<sup>5를</sup> 사용한 정보 권한 관리|아니요|아니요|아니요|
...
> <sup>1</sup> Office 365 Germany 계획에는 Office 365 ProPlus, Office 2013 및 Office 2016과 같은 최종 사용자의 디바이스("클라이언트 소프트웨어 응용 프로그램")에서 설치 및 실행되는 클라이언트 소프트웨어 응용 프로그램이 포함됩니다. 클라이언트 소프트웨어 응용 프로그램은 독일 데이터 센터에서만 작동하지는 않습니다. 최종 사용자가 독일어 온라인 서비스가 아닌 온라인 서비스에 액세스할 수 있습니다. Microsoft와의 계약을 위해 클라이언트 소프트웨어 응용 프로그램은 독일어 온라인 서비스가 아닙니다. 독일어 데이터 트러스티에 의한 액세스 제어 및 독일어 데이터 상주 약정은 독일어 온라인 서비스에만 적용됩니다.<br/>
<sup>2</sup> Office 2013을 사용하려면 [modern authentication be enabled](https://support.office.com/article/776c0036-66fd-41cb-8928-5495c0f9168a).<br/>
<sup>3</sup> 보관 및 규정 준수 기능은 이 Office 버전에서 지원되지만 Exchange Online 및 SharePoint Online 계획은 포함되어 있지 않으므로 별도 구입하거나 지원 가능한 온-프레미스 서버 동급의 제품과 함께 사용해야 합니다.<br/> <sup>4</sup> Azure Information Protection은 포함되어 있지 않지만 지원되는 IRM 기능을 사용하도록 설정하기 위해 별도의 추가 기능으로 구입할 수 있습니다.<br/> <sup>5</sup> Windows Server AD RMS는 온-프레미스 서버이며, 별도로 구입하여 지원되는 IRM 기능을 사용할 수 있습니다.<br/>
...
<sup>8</sup> Office 2011 for Mac을 설치할 수 있으나 정품 인증을 받을 수 없습니다.<br/>
<sup>9</sup> Office 365 ProPlus는 사용자 전용 VDI(가상 데스크톱 인프라)에서 지원됩니다. Office 365 ProPlus는 볼륨 라이선스 프로그램을 통해 구매한 경우만 RDS(원격 데스크톱 서비스)를 지원합니다.<br/>
...
다음 표에서는 Office 365 Germany 계획에서 사용할 수 있는 웹 기능의 Office와 다양한 기능을 제공하는 데스크톱 앱의 Microsoft Office 링크가 제공됩니다. 비교를 사용하여 웹용 Office에서 사용할 수 있는 기능을 검색한 다음 기능 이름을 선택하여 해당 기능의 작동 방식에 대한 간략한 설명을 읽어 봐야 합니다. 조직의 일부 사람이 Excel 데스크톱 앱의 고급 차트 기능을 필요로 하는 반면 다른 사람은 웹용 Office를 사용하여 Word 문서 및 PowerPoint 프레젠테이션을 보고 밝게 편집해야 할 수 있습니다.
...
> - Microsoft Office Web Apps Server 2013의 경우 Office 데스크톱 제품군 라이선스(예: Office Professional Plus, Office Standard 또는 Office 365 ProPlus 라이선스)를 구입한 경우 웹 편집 라이선스에 대한 Office가 제공됩니다. <br/>
> - Office 365 Germany의 특성으로 인해 아직 활성화되지 않은 일부 기능이 있습니다. 고객은 시간에 따라 글로벌 서비스를 포함하는 전체 기능 패리티에 근접한 서비스를 확인할 수 있습니다.
...
|하이브리드 배포 지원<sup>1</sup>|예<sup>2</sup>|예|예<sup>2</sup>|예|예|예|예|예|
...
|Office 365 메시지 암호화|아니요<sup>4</sup>|아니요<sup>4</sup>|아니요<sup>4</sup>|아니요<sup>4</sup>|아니요<sup>4</sup>|예|예|아니요<sup>4</sup>|
...
|기본 제공 스팸 방지 보호 기능|예|예|예|예|예|예|예|예|
|Customize anti-spam policies|예|예|예|예|예|예|예|예 <sup>8</sup>|
|기본 제공 맬웨어 방지 보호 기능|예<sup>9</sup>|예<sup>9</sup>|예<sup>9</sup>|예<sup>9</sup>|예<sup>9</sup>|예<sup>9</sup>|예<sup>9</sup>|예<sup>9</sup>|
...
|인바운드 안전한 목록에 파트너 추가|예|예|예|예|예|예|예|예|
...
|클러터<sup>3</sup>|아니요|아니요|아니요|아니요|아니요|아니요|아니요|아니요|
...
|비활성 사서함|<sup>11 없음</sup>|--|<sup>11 없음</sup>|예|<sup>11 없음</sup>|예|예|<sup>11 없음</sup>|
|오프라인 주소록|예|예|예|예|예|예|예|예|
|주소록 정책|예|예|예|예|예|예|예|예|
|계층적 주소부|예|--|예|예|예|예|예|아니요|
...
|페더링 공유(일정 게시 포함)<sup>13</sup>|예|예|예|예|예|예|예|예|
...
|Windows<sup>14용</sup> Outlook|예|예|예|예|예|예|예| <sup>11 없음</sup>|
|웹에서 Outlook<sup>14</sup>|예|예|예|예|예|예|예|예|
|Outlook for Mac<sup>14</sup>|예|예|예|예|예|예|예|예|
|iOS 및 Android<sup>14용</sup> Outlook|아니요|아니요|아니요|아니요|아니요|아니요|아니요|아니요|
...
|음성 메일과 타사 팩스 간의 통합|아니요|아니요|아니요|아니요|아니요|예|예|아니요|
...
> [!NOTE]
> <sup>1</sup> Exchange 2010은 최소 하이브리드 배포만 지원됩니다. Exchange 2010에서는 전체 하이브리드 배포가 지원되지 않습니다. 최소 하이브리드 배포에 대한 자세한 내용은 Express 마이그레이션을 사용하여 Exchange 사서함을 [Office 365로 마이그레이션하는 방법을 참조하세요.](https://support.office.com/article/fdecceed-0702-4af3-85be-f2a0013937ef)<br/>
<sup>2</sup> Office 365 Germany Business Essentials 및 Office 365 Germany Business Premium은 Office 365 Germany Business Premium에 대한 액세스 권한을 제공하지 않습니다. 규정을 준수하려면 고객은 적절한 CA를 구매하거나 이전에 구매했거나 이러한 액세스 권한을 제공하는 엔터프라이즈 SKU로 업그레이드해야 합니다.<br/>
<sup>3</sup> Office 365 Germany에서는 사용할 수 없지만 곧 제공될 예정입니다.<br/>
<sup>4</sup> Azure Information Protection은 포함되지 않지만 지원되는 IRM 기능을 사용하도록 설정하기 위해 별도 추가 기능(또는 Office 365 Germany Education A1 계획에 무료로 추가)으로 구매할 수 있습니다. Office 365 메시지 암호화는 Azure Information Protection에 따라 달라 습니다.<br/>
<sup>5</sup> Windows Server AD RMS는 온-프레미스 서버이며, 별도로 구입하여 지원되는 IRM 기능을 사용할 수 있습니다.<br/>
<sup>6</sup> eDiscovery의 경우, 클라우드와의 별도 쿼리가 필요합니다.<br/>
<sup>7</sup> 메일 흐름 규칙(전송 규칙)은 조건을 기반으로 수행할 조건, 예외 및 작업을 정의할 수 있는 유연한 조건으로 구성됩니다. Exchange Online과 Exchange Online 간에 사용 가능한 조건, 예외 및 Microsoft Exchange Server. 자세한 내용은 각 제품에 대한 해당 항목을 참조하세요.<br/>
<sup>8</sup> EAC(Exchange 관리 센터) 관리 인터페이스에 직접 액세스하여만 액세스할 수 있습니다. <br/>
<sup>9</sup> Exchange Server 2013에서는 Microsoft 맬웨어 방지 엔진만 사용했습니다. Exchange Online에서는 여러 맬웨어 방지 엔진을 사용하여 인바운드, 아웃바운드 및 내부 메시지에서 맬웨어를 검사합니다. <br/> <sup>연결된 계정 10개는</sup> POP IMAP 계정에 대해 지원되지만 &amp; Hotmail(Hotmail)에서는 Outlook.com 사용하지 않도록 설정됩니다. <br/>
<sup>11</sup> 비활성 사서함 기능이 필요한 각 사서함에 대해 EOA 구독을 별도로 구매할 수 있습니다. <br/>
<sup>12</sup> cmdlet을 사용하여 주소 목록 및 전체 주소 목록으로 작업할 수 없습니다. <br/>
<sup>13</sup> 가용성 주소 공간을 사용하여 다른 테넌트와의 공유를 지원해야 합니다. 가용성 주소 공간을 만드는 방법에 대한 자세한 내용은 [Add-AvailabilityAddressSpace를 참조하십시오.](https://docs.microsoft.com/powershell/module/exchange/Add-AvailabilityAddressSpace) <br/> <sup>14</sup> 표는 클라이언트가 연결된 계획에서 작동하는지 여부를 나타냅니다. 이러한 계획 구매에 클라이언트가 반드시 포함되어야 하는 것을 의미하지는 않습니다.<br/>
<sup>15</sup> POP가 지원되지만 IMAP은 지원되지 않습니다.<br/>
<sup>16</sup> 일부 타사 웹 파트 및 추가 기능을 사용할 수 없는 경우도 있습니다.

## <a name="exchange-online-protection-features"></a>Exchange Online Protection 기능

다음 표에는 Office 365 Germany 계획에서 사용할 수 있는 EOP(Exchange Online Protection) 기능이 나와 있습니다. EOP 기능에 대한 자세한 내용을 확인하려면 표의 링크를 선택합니다. Exchange Online은 대개 Office 365 Enterprise 서비스 제품군을 지칭하는 것입니다.<br><br>
...
|[웹에서 Outlook의 정크 메일 보고](https://docs.microsoft.com/microsoft-365/security/office-365-security/report-junk-email-and-phishing-scams-in-outlook-on-the-web-eop)|예<sup>8</sup>|아니요<sup>8</sup>|아니요<sup>8</sup>|
...
|[Microsoft 365 관리 센터에 대한 액세스](../exchange-online-protection-service-description/administration-and-management-eop.md#access-to-the-microsoft-365-admin-center)<br/> |예|예|예|
...
<sup>7</sup> 기본 콘텐츠 필터 동작은 스팸 메시지를 받는 사람의 정크 메일 폴더로 이동하는 것입니다. 이 규칙이 On-premises Exchange 사서함에서 작동하려면 EOP에서 추가한 스팸 헤더를 검색하도록 두 전송 규칙도 구성해야 합니다. 자세한 내용은 스팸이 각 사용자의 정크 메일 폴더로 라우팅되도록 [합니다.](https://docs.microsoft.com/microsoft-365/security/office-365-security/ensure-that-spam-is-routed-to-each-user-s-junk-email-folder)<br/>
...
<sup>12</sup> Azure Information Protection을 구매하고 Exchange Online Protection을 사용하여 Exchange Online을 통해 전자 메일을 라우팅하는온-프레미스 고객에게 지원됩니다.<br/>
...
<sup>15</sup> 하이브리드 설정은 하이브리드 마법사를 통해 사용할 수 없지만 Exchange SP1이 있는 경우 수동으로 설정할 수 있습니다.<br/>
<sup>16</sup> Office 365 Germany E1 이상에서 사용할 수 있습니다.<br/>
<sup>17</sup> Office 365 Germany E3에서 사용할 수 있습니다.<br/>
<sup>18</sup> Office 365 Germany의 추가 기능으로 사용할 수 있습니다.

## <a name="defender-for-office-365-features"></a>Office 365 기능용 Defender

다음 표에는 Office 365 Germany 계획에서 사용할 수 있는 Office 365용 Defender 기능이 나열됩니다. Exchange Online은 대개 Office 365 Enterprise 서비스 제품군을 지칭하는 것입니다.<br><br>

| 기능 | Office 365 독립 실행형 Defender | Exchange Online의 Office 365 기능용 Defender |
|:-----|:-----|:-----|
|안전한 링크|예|예|
|안전한 첨부 파일|예|예|
...
|Project Online Professional| 모든 Project Online Essentials 기능과 다음 기능 포함  <br/>  데스크톱 클라이언트를 통한 풍부한 사용자 인터페이스  <br/>  웹 인터페이스를 통한 언제/어디서나 액세스  <br/>  프로젝트 예약 및 비용 관리  <br/>  자원 관리  <br/>  클라우드에 프로젝트 게시  <br/>  최신 버전의 Project 데스크톱 응용 프로그램을 Windows PC에 즉시 스트리밍하도록 포함합니다.  <br/>  구독 라이선스마다 최대 5개의 동시 Project 데스크톱 응용 프로그램 설치가 허용됩니다.|프로젝트 관리자|
...
|앱 배포: SharePoint 호스팅 앱|예|예|예|예|예|예|예|예|
|앱 관리 서비스|예|예|예|예|예|예|예|예|
|BCS: 외부 목록에 대한 경고|아니요|아니요|아니요|예|아니요|예|예|아니요|
|BCS: 앱 범위 외부 콘텐츠 형식(EC)|아니요|아니요|아니요|예|아니요|예|예|아니요|
...
|BCS: 다양한 클라이언트 통합|아니요|아니요|아니요|아니요|아니요|아니요|아니요|아니요|
...
|사용자 지정 사이트 프로비전 페이지|아니요|아니요|아니요|아니요|아니요|아니요|아니요|아니요|
|개발자 사이트|예|아니요|예|예|예|예|예|예|
|양식 기반 응용 프로그램|예|아니요|예|예|예|예|예|예|
...
|SharePoint 2010 워크플로(첫 실행)|예|아니요|예|예|예|예|예|예|
...
|향상된 사용 권한 관리|예|예|예|예|예|예|예|예|
|향상된 셀프 서비스 사이트 만들기|아니요|아니요|예|아니요|아니요|아니요|아니요|아니요|
|관리되는 계정|아니요|아니요|아니요|아니요|아니요|아니요|아니요|아니요|
|Minimal Download Strategy (MDS)|예|예|예|예|예|예|예|예|
|OAuth|예<sup>8</sup>|예<sup>8</sup>|예<sup>8</sup>|예<sup>8</sup>|예<sup>8</sup>|예<sup>8</sup>|예<sup>8</sup>|예<sup>8</sup>|
|패치 관리|아니요|아니요|아니요|아니요|아니요|아니요|아니요|아니요|
|할당량 지정 서식 파일|아니요|아니요|아니요|아니요|아니요|아니요|아니요|아니요|
|읽기 전용 데이터베이스 지원|아니요|아니요|아니요|아니요|아니요|아니요|아니요|아니요|
|원격 BLOB 저장소|아니요|아니요|아니요|아니요|아니요|아니요|아니요|아니요|
...
|SharePoint 관리 센터(Office 365)|예|예|예|예|예|예|예|아니요<sup>4</sup>|
|Shredded Storage|예|예|예|예|예|예|예|예|
|사이트 모음 준수 정책|예|예|예|예|예|예|예|예|
...
|연결되지 않은 콘텐츠 데이터베이스 복구|아니요|아니요|아니요|아니요|아니요|아니요|아니요|아니요|
...
|접근성 표준 지원|예|예|예|예|예|예|예|예|
|자산 라이브러리 기능 향상/비디오 지원|예|예|예|예|예|예|예|예|
|감사|예|예|예|예|예|예|예|예|
|감사 &amp; 보고(예: doc 편집, 정책 편집, 삭제)|예|예|예|예|예|예|예|예|
|Content Organizer|예|아니요|예|예|예|예|예|예|
|Design Manager|예|아니요|예|예|예|예|예|예|
|문서 집합|예|예|예|예|예|예|예|예|
|웹용 Word의 문서 번역|예|예|예|예|예|예|예|예|
|eDiscovery 검색|예<sup>6</sup>|예|예<sup>6</sup>|예<sup>6</sup>|예<sup>6</sup>|예<sup>6</sup>|예<sup>6</sup>|예<sup>6</sup>|
|eDiscovery 보류|아니요<sup>6</sup>|아니요|아니요<sup>6</sup>|예<sup>6</sup>|아니요<sup>6</sup>|예<sup>6</sup>|예<sup>6</sup>|아니요<sup>6</sup>|
|eDiscovery 내보내기|아니요<sup>6</sup>|아니요|아니요<sup>6</sup>|예<sup>6</sup>|아니요<sup>6</sup>|예<sup>6</sup>|예<sup>6</sup>|아니요<sup>6</sup>|
|전자 메일 사용 목록 및 라이브러리|아니요|아니요|아니요|아니요|아니요|아니요|아니요|아니요|
|외부 공유: 외부 액세스|<sup>아니요 9</sup>|아니요<sup>9</sup>|<sup>아니요 9</sup>|아니요<sup>9</sup>|아니요<sup>9</sup>|아니요<sup>9</sup>|아니요<sup>9</sup>|아니요<sup>9</sup>|
|외부 공유: 게스트 링크|<sup>아니요 9</sup>|<sup>아니요 9</sup>|<sup>아니요 9</sup>|<sup>아니요 9</sup>|<sup>아니요 9</sup>|<sup>아니요 9</sup>|<sup>아니요 9</sup>|<sup>아니요 9</sup>|
|폴더 동기화|예<sup>1, 10</sup>|예|예<sup>1, 9</sup>|예<sup>1, 9</sup>|예<sup>1</sup>|예|예|예<sup>2, 10</sup>|
|하이브리드 감사|아니요|아니요|아니요|아니요|아니요|아니요|아니요|아니요|
|하이브리드 세분화 및 콘텐츠 형식|예|예|예|예|예|예|예|예<sup>20</sup>|
|IRM(정보 권한 관리)|아니요<sup>3</sup>|아니요|아니요<sup>3</sup>|예|아니요<sup>3</sup>|예|예|아니요<sup>3, 4</sup>|
|IRM(정보 권한 관리)|아니요|아니요|아니요|아니요|아니요|아니요|아니요|아니요|
|Managed Metadata Service|예|아니요|예|예|예|예|예|예|
|메타데이터 기반 탐색|예|아니요|예|예|예|예|예|예|
|다단계 분해|예|예|예|예|예|예|예|예|
...
|Faceted navigation|아니요|아니요|아니요|아니요|아니요|예<sup>7</sup>|예<sup>7</sup>|아니요|
...
|계산된 측정값 및 구성원|아니요|아니요|아니요|예|아니요|예|예|아니요|
...
|향상된 필터|아니요|아니요|아니요|예|아니요|예|예|아니요|
...
|대시보드의 & 기록표|아니요|아니요|아니요|아니요|아니요|아니요|아니요|아니요|
...
|웹용 Visio<sup>18</sup>|예|예|예|예|예|예|예|예|
...
|Event-based relevancy|예|예|예|예|예|예|예|예|
|전문 지식 검색|예|예|예|예|예|예|예|예|
...
|교차 브라우저 지원|예|예|예|예|예|예|예|예|
|사용자 지정 관리 경로|아니요|아니요|아니요|아니요|아니요|아니요|아니요|아니요|
|거버넌스|예|예|예|예|예|예|예|예|
|하이브리드 앱 시작 프로그램|예|예|예|예|예|예|예|예<sup>19</sup>|
|하이브리드 비즈니스용 OneDrive 및 사이트|예|예|예|예|예|예|예|예<sup>19</sup>|
|큰 목록 확장성 및 관리|예|예|예|예|예|예|예|예|
|모바일 연결|아니요|예<sup>11</sup>|예<sup>11</sup>|예<sup>11</sup>|예<sup>11</sup>|예<sup>11</sup>|예<sup>11</sup>|예<sup>11</sup>|
|다국어 사용자 인터페이스|예<sup>12</sup>|예<sup>12</sup>|예<sup>12</sup>|예<sup>12</sup>|예<sup>12</sup>|예<sup>12</sup>|예<sup>12</sup>|예<sup>12</sup>|
|My Tasks|예|아니요|예|예|예|예|예|예|
|OOTB 웹 파트|예|아니요|예|예|예|예|예|예|
|Permissions Management|예|예|예|예|예|예|예|예|
|Project functionality for team sites|예|아니요|예|예|예|예|예|예|
|Project site template|예|아니요|예|예|예|예|예|예|
|Project Summary web part|예|아니요|예|예|예|예|예|예|
|Project workspace|예|아니요|예|예|예|예|예|예|
|SharePoint 목록|예|아니요|예|예|예|예|예|예|
|SharePoint 리본 메뉴|예|아니요|예|예|예|예|예|예|
|문서 라이브러리|예|아니요|예|예|예|예|예|예|
|Task list|예|아니요|예|예|예|예|예|예|
|팀 사이트: 끌어서 & 놓기|예|아니요|예|예|예|예|예|예|
|팀 전자 필기장|예|아니요|예|예|예|예|예|예|
|팀 사이트: 간편한 액세스|예|아니요|예|예|예|예|예|예|
|사이트 디자인|예|아니요|예|예|예|예|예|예|
|사이트 테마(모양 변경)|예|아니요|예|예|예|예|예|예|
|사이트 사용 페이지|예|아니요|예|예|예|예|예|예|
|Variations|예|아니요|예|예|예|예|예|아니요|
|Work Management Service|예|아니요|예|예|예|예|예|예|
...
|사이트 피드(SharePoint 소셜을 사용하는 클래식 팀 사이트)|예|아니요|예|예|예|예|예|예|
...
|Azure 프로비전 앱: Access Services|예<sup>15</sup>|예<sup>15</sup>|예<sup>15</sup>|예<sup>15</sup>|예<sup>15</sup>|예<sup>15</sup>|예<sup>15</sup>|예<sup>15</sup>|
|Azure 프로비전 앱: Azure LWR(Lightweight Web Role)의 사용자 지정 코드|예|예|예|예|예|예|예|예|
|Duet Online|아니요|아니요|아니요|예|아니요|예|예|아니요|

> [!NOTE]
> <sup>1</sup> 폴더 동기화를 사용하려면 Office 2013 이상(Standard 또는 Professional Edition) 또는 Office 응용 프로그램이 포함된 구독이 있어야 합니다. Office 365 Germany Business Essentials, Office 365 Germany Enterprise E1Office 365 Germany Enterprise E1 및 Office 365 Germany Education A1 에는 Office 데스크톱 응용 프로그램에 대한 구독이 포함되지 않습니다. 그러나 Office 2013 이상이 설치되어 있고 계획 중 하나를 구독한 경우 폴더 동기화를 사용할 수 있습니다.<br/>
...
<sup>3</sup> Azure Information Protection은 포함되어 있지 않지만 지원되는 IRM 기능을 사용하도록 설정하기 위해 별도의 추가 기능으로 구매할 수 있습니다. RMS로 보호된 콘텐츠를 만들하려면 Office Professional Plus 2013, Office Professional Plus 2016, Microsoft 365 앱 또는 Outlook Web Access가 있어야 합니다.<br/>
<sup>4</sup> Kiosk 사용자는 관리자일 수 없으므로, 관리 센터에 액세스하려면 Kiosk 사용자가 있는 테넌트에 엔터프라이즈 사용자가 한 명 이상 필요합니다. <br/>
<sup>5</sup> SharePoint Online 고객은 순위 모델을 만들고 사용자 지정하기 위해 무료 순위 모델 조정 앱을 다운로드하고 설치해야 합니다.<br/>
...
<sup>15</sup> Access 2010은 지원되지 않습니다.<br/> <sup>16</sup> 키오스크 사용자는 라이브 타일을 사용하여 Office 문서를 만들 수 없습니다. 문서를 만들 때 키오스크 사용자는 새 파일 만들기 메뉴에서 새로  만들기를 선택한 다음 Word 문서, Excel 통합 문서, PowerPoint 프레젠테이션, OneNote 전자  필기장 또는 Excel 설문 조사 파일 형식을 선택하여 SharePoint Online 사이트에서 이를 선택해야 합니다. <br/>
<sup>17</sup> 사용자 코드(샌드박스)가 포함된 InfoPath 양식은 InfoPath 리치 클라이언트에서만 사용될 수 있습니다.<br/>
<sup>웹용 18</sup> Visio(보기 기능)를 무료로 사용할 수 있습니다. 웹용 Visio에서 만들기 및 편집 기능을 사용하려면 라이선스가 필요합니다. 웹용 Visio에 대한 자세한 내용은 [Visio에서](../visio-online-service-description/visio-online-service-description.md)웹 서비스 설명을 참조하십시오.<br/>
<sup>19</sup> K1 사용자는 하이브리드 설치에서 SharePoint Server에 액세스할 수 있지만 Office 365 K1에는 서버에 액세스할 수 있는 CAL 권한이 포함되어 있지 않습니다. 이러한 권한은 별도로 구매해야 합니다.
...
|통합 연락처 저장소|아니요<sup>6</sup>|아니요<sup>6</sup>|아니요<sup>6</sup>|아니요<sup>6</sup>|아니요<sup>6</sup>|아니요<sup>6</sup>|아니요|
...
|Skype 페더레이션|아니요<sup>6</sup>|아니요|아니요<sup>6</sup>|아니요<sup>6</sup>|아니요<sup>6</sup>|아니요<sup>6</sup>|아니요|
...
|공인 ACP(오디오 회의 공급자)를 통한 비즈니스용 Skype 모임 전화 접속|아니요<sup>6</sup>|아니요<sup>6</sup>|아니요<sup>6</sup>|아니요<sup>6</sup>|아니요<sup>6</sup>|아니요<sup>6</sup>|아니요|
...
|Skype 모임 브로드캐스트<sup>6</sup>|아니요|아니요|아니요<sup>6</sup>|아니요|아니요<sup>6</sup>|아니요<sup>6</sup>|아니요|
...
|웹 스케줄러를 통해 비즈니스용 Skype 모임 예약|아니요<sup>6</sup>|아니요<sup>6</sup>|아니요<sup>6</sup>|아니요<sup>6</sup>|아니요<sup>6</sup>|아니요<sup>6</sup>|아니요|
|웹에서 Outlook의 온라인 모임 예약|예|예|예|예|예|예|아니요|
...
|[통화 플랜(국내](../skype-for-business-online-service-description/skype-for-business-online-features.md#calling-plans) 통화 요금제, 추가 기능 구매 필요)|아니요|아니요|아니요|아니요|아니요<sup>4</sup>|아니요<sup>4</sup>|아니요|
|[통화 플랜(국제](../skype-for-business-online-service-description/skype-for-business-online-features.md#calling-plans) 통화 플랜, 추가 기능 구매 필요)|아니요|아니요|아니요|아니요|아니요<sup>4</sup>|아니요<sup>4</sup>|아니요|
...
|IM 콘텐츠 보관|<sup>아니요 2</sup>|<sup>아니요 2</sup>|<sup>아니요 2</sup>|<sup>아니요 2</sup>|예|예|아니요|
|회의 콘텐츠 보관|<sup>아니요 2</sup>|<sup>아니요 2</sup>|<sup>아니요 2</sup>|<sup>아니요 2</sup>|예|예|아니요|
|응용 프로그램 공유 및 데스크톱 공유 보관|아니요|아니요|아니요|아니요|아니요|아니요|아니요|
|사용자 수준 보관 구성|<sup>아니요 2</sup>|<sup>아니요 2</sup>|<sup>아니요 2</sup>|<sup>아니요 2</sup>|예|예|아니요|
...
<sup>5</sup> Skype consumer calls are not supported in Office 365 Germany because there is no Skype consumer federation upon which to make calls. 그러나 페더링된 통화는 지원됩니다.<br/>
<sup>6</sup> Not available in Office 365 Germany, but coming soon.

## <a name="visio-for-the-web-features"></a>웹용 Visio 기능

웹용 Visio는 Office 365 Germany에서 사용할 수 있습니다. 웹용 Visio에 대한 자세한 내용은 [Visio에서](../visio-online-service-description/visio-online-service-description.md)웹 서비스 설명을 참조하십시오.

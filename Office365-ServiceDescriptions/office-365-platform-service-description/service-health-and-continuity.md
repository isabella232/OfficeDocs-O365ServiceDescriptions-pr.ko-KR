...
Office 365 서비스 통신 API를 사용 하면 원하는 방식으로 Office 365 서비스 통신에 액세스할 수 있습니다. 이제 이 새로운 관리 도구를 사용하여 도구를 만들거나 Office 365 서비스 통신에 도구를 연결하여 환경을 모니터링 방법을 단순화할 수 있습니다. 서비스 통신 API를 사용 하면 환경에서 다음을 모니터링할 수 있습니다.

...
이 항목에 나열된 기능은 여러 장치 및 여러 서비스에서 안전하게 공동 작업하고 통신하는 데 도움이 되는 웹 기반 Office 365 모음입니다. 이러한 기능은 사용자 간에 정보를 검색하고 공유하기 위한 소셜 도구를 사용해서 디지털 콘텐츠 만들기, 저장 및 관리를 통합함으로써 조직 내에서 새로운 연결을 만드는 데 도움이 됩니다.
  
## <a name="delve"></a>Delve

Delve 통해 사용자는 개인화된 인사이트를 기반으로 여러 Microsoft 365 검색할 수 있습니다. Delve는 Office Graph를 기반으로 하는 최초의 작업 환경입니다. 자세한 내용은 Delve what [is Delve?](https://go.microsoft.com/fwlink/?LinkId=511463)을(를) Delve.
...
브리핑 전자 메일은 사용자의 모든 사용자에게 Exchange Online. 자세한 내용은 브리핑 전자 메일 [개요를 참조하세요.](/Briefing/be-overview)

## <a name="microsoft-power-automate"></a>Microsoft Power Automate

Microsoft Power Automate 사용하여 여러 응용 프로그램에서 워크플로를 자동화할 수 있습니다. Flow를 사용하여 전자 메일 및 IM 알림을 연결하고, 응용 프로그램 간에 파일을 동기화하며, 한 서비스에서 다른 서비스로 파일을 복사하고, 한 앱에서 데이터를 수집하여 다른 앱에 저장하는 등의 작업을 수행할 수 있습니다. 시작하기 위한 템플릿을 제공합니다. Flow 기능 및 사용 방법에 대한 자세한 내용은 Power Automate [웹 사이트로 이동하세요.](https://preview.flow.microsoft.com/)
  
## <a name="microsoft-forms"></a>Microsoft Forms

Microsoft Forms를 사용하면 사용자 지정 퀴즈, 설문 조사, 설문 조사, 등록 등 쉽고 빠르게 만들 수 있습니다. 퀴즈 또는 설문지를 만들 때 모든 웹 브라우저를 사용하여 모바일 장치에서도 다른 사용자가 응답하도록 초대 할 수 있습니다. 결과가 제출되면 기본 제공 분석을 사용하여 응답을 평가할 수 있습니다. 퀴즈 결과와 같은 양식 데이터를 추가 분석 또는 Excel 위해 양식 데이터로 쉽게 내보낼 수 있습니다. 자세한 내용은 [Microsoft Forms란?을 참조하세요.](https://support.office.com/forms)
  
## <a name="microsoft-graph-api"></a>Microsoft Graph API

Microsoft Graph API를 사용하여 단일 끝점을 통해 다양한 리소스, 관계 및 인텔리전스에 연결하는 앱을 빠르게 https://graph.microsoft.com 빌드합니다. . 예를 들어 조직의 데이터를 검색하는 사용자 지정 대시보드, 워크플로 및 앱을 빌드할 수 있습니다. 자세한 내용은 Microsoft Graph [참조하십시오.](/graph/overview)
...
Microsoft Power Apps 모든 장치에서 작동되는 앱을 빠르게 빌드, 통합 및 공유할 수 있도록 하는 엔터프라이즈 서비스입니다. Power Apps 기본 제공 연결 또는 회사에서 구축한 연결을 사용하여 Microsoft 365 및 Office 365, Dynamics CRM, OneDrive, SharePoint, SQL Server, Oracle 데이터베이스 등의 클라우드 및 Office 365 서비스에 연결할 수 있습니다. 전자 메일 주소를 입력하여 동료와 Power Apps 쉽게 공유할 수 있습니다. 자세한 내용은 Microsoft Power Apps 웹 [사이트로 이동하세요.](https://powerapps.microsoft.com/)
...
그룹의 Microsoft 365 더 많은 기능을 수행하기 위해 필요한 동료, 정보 및 응용 프로그램과 사용자를 연결합니다. 그룹은 기본적으로 검색 기능과 공유 기능을 향상하기 위해 열려 있지만, 사용자는 중요한 콘텐츠에 대한 비공개 그룹을 만들 수도 있습니다. 그룹에 대한 자세한 내용은 에서 [그룹을 Microsoft 365.](https://support.office.com/Article/Find-help-about-Groups-in-Office-365-7a9b321f-b76a-4d53-b98b-a2b0b7946de1) 그룹 제한에 대한 자세한 내용은 그룹 정보의 "내 그룹을 관리하는 [방법"을 Microsoft 365 참조하세요.](https://go.microsoft.com/fwlink/?linkid=846714)
...
Microsoft To Do 응용 프로그램은 고객이 모든 장치에서 업무와 생활에서 하루를 계획하고 작업을 관리할 수 있도록 하는 작업 관리 응용 프로그램입니다.

이 Microsoft To Do 사용하여 고객은 다음을 할 수 있습니다.

* 작업, Outlook, Teams, Planner 등에서 작업 동기화
...
* 미리 구성된 Windows 업데이트 정책을 무시하여 조직 전체에 보안 업데이트를 즉시 배포
...
이러한 기능은 Microsoft Graph API를 통해 사용할 수 있으며 Microsoft Endpoint Manager. 자세한 내용은 Windows 업데이트 배포 서비스 [개요를 참조하세요.](https://aka.ms/wufb/deployment-service)

## <a name="whiteboard"></a>Whiteboard

Microsoft Whiteboard, 콘텐츠 및 아이디어가 함께 어우러진 자유형 디지털 캔버스입니다. 화이트보드를 사용하여 팀과 공동 작업을 수행하여 팀이 같은 위치에 있는지 아니면 여러 위치에 있는지에 따라 다양한 활동을 수행할 수 있습니다. 팀 구성원은 자신의 장치를 사용하여 공동 작업을 할 수 있습니다.

앱에 대한 Microsoft Whiteboard [디지털 온라인 화이트보드](https://www.microsoft.com/microsoft-365/microsoft-whiteboard/digital-whiteboard-app)앱 - Microsoft Whiteboard.

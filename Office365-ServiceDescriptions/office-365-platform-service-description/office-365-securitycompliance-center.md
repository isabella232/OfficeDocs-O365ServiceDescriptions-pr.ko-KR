...
<sup>8</sup> 1-E5를 제외한 기본 감사를 포함 하는 모든 계획에 대 한 감사 로그는 90 일 동안 보존 됩니다. E5에는 고급 감사가 포함 되므로 감사 로그는 최대 1 년까지 보존 됩니다. 또한 [Office 365 관리 활동 API](https://docs.microsoft.com/office/office-365-management-api/office-365-management-activity-api-reference) 를 사용 하 여 통합 된 감사 로그에서 이벤트를 검색할 수 있습니다.
...
<sup>8</sup> 90 일 동안 기본 감사를 포함 하는 모든 계획에 대 한 감사 로그를 보존 합니다. 또한 [Office 365 관리 활동 API](https://docs.microsoft.com/office/office-365-management-api/office-365-management-activity-api-reference) 를 사용 하 여 통합 된 감사 로그에서 이벤트를 검색할 수 있습니다.

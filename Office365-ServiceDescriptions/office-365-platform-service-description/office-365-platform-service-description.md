...
Microsoft 365 및 Office 365는 조직의 요구 사항을 가장 잘 충족하기 위해 다양한 계획으로 제공됩니다. Exchange Online 요금제와 계획 간의 차이점을 찾고 있는 경우 이 문서에서는 각 계획에 포함된 기능을 보여 주게 됩니다.
  
Microsoft 365 및 Office 365는 모든 크기의 기업에 클라우드 생산성의 파워를 제공하여 시간과 비용을 절약하고 가치 있는 리소스를 확보합니다. Microsoft 365 및 Office 365 요금제는 익숙한 Microsoft Office 데스크톱 제품군과 클라우드 기반 버전의 Microsoft 차세대 통신 및 공동 작업 서비스(Microsoft Exchange Online, Microsoft SharePoint Online, 웹용 Office 및 Microsoft 비즈니스용 Skype Online)를 결합하여 사용자가 인터넷을 통해 거의 모든 곳에서 생산성을 향상할 수 있도록 합니다.
  
계획 간 기능을 비교할 수 있는 강력한 도구를 참조하세요. 또는 보다 자세한 기능 목록은 [Microsoft 365 및 Office 365](../office-365-service-descriptions-technet-library.md)서비스 설명 아래에서 관련 서비스 설명을 참조하세요. [](https://go.microsoft.com/fwlink/?LinkID=799177&amp;clcid=0x409)
...
- Office 365 Germary에 대한 내용은 [Office 365 Germany](office-365-germany.md) 페이지부터 확인하세요. 
    
## <a name="office-365-plans"></a>Office 365 요금제

Office 365는 조직의 요구 사항을 가장 효율적으로 충족할 수 있도록 다양한 계획으로 제공됩니다. 독립 실행형 계획 옵션 및 계획에서 다른 요금제로의 이동에 대한 정보는 [Office 365](office-365-plan-options.md)계획 옵션을 참조하세요.
  
볼륨 라이선스에 대한 자세한 내용은 사용 조건 [및 설명서를 참조하세요.](https://go.microsoft.com/fwlink/?linkid=848696)
  
## <a name="microsoft-365-and-office-365-plans-and-pricing-for-nonprofits"></a>비영리단체에 대한 Microsoft 365 및 Office 365 요금제 및 가격

비영리 조직용 Microsoft 365 및 Office 365 요금제의 자격이 있는 조직의 경우 이러한 요금제에는 해당 비즈니스 계획과 정확히 동일한 기능이 포함됩니다(예: 비영리 기관용 Office 365 E5에는 Office 365 E5와 동일한 기능이 포함). 동급 요금제 간의 유일한 차이는 지불하는 가격입니다. 비영리용 Microsoft 365 및 Office 365 요금제에 대한 자세한 내용은 비영리용 [Microsoft 365 및 Office 365](https://go.microsoft.com/fwlink/?LinkID=627221)제품 및 비영리용 생산성 솔루션 비교를 참조하세요. [](https://go.microsoft.com/fwlink/?LinkID=786641)
  
## <a name="system-requirements"></a>시스템 요구 사항

비즈니스, 교육 및 정부 조직에서 사용할 수 있는 월별 구독 기반 서비스인 Microsoft 365 및 Office [365에](https://products.office.com/office-system-requirements/#Office365forBEG)대한 시스템 요구 사항은 Microsoft 365 및 Office 리소스에 대한 시스템 요구 사항을 참조하세요.
  
## <a name="service-level-agreement"></a>서비스 수준 계약

서비스 수준 계약에 대한 내용은 [서비스 수준 계약](https://go.microsoft.com/fwlink/?linkid=843153)을 참조하세요. Office 365의 최근 사용 시간에 대한 자세한 내용은 서비스 상태 및 [연속성을 참조하세요.](https://go.microsoft.com/fwlink/?linkid=848695)
  
## <a name="security-amp-compliance-center"></a>Security &amp; Compliance Center

보안 준수 센터 및 추가 정보 및 가용성에 대한 링크에 대한 자세한 내용은 &amp; 보안 준수 [ &amp; 센터를 참조하세요.](office-365-securitycompliance-center.md)
...
Multi-Geo를 사용하면 단일 조직이 여러 Office 365 데이터 센터 지역을 포커스할 수 있으며, Exchange Online 및 비즈니스용 OneDrive에 대한 데이터를 사용자에 따라 선택한 지리적 위치로 저장하는 기능을 제공합니다. 
  
사용 가능한 지역: 아시아 태평양, 오스트레일리아, 캐나다, 유럽 연합, 인도, 일본, 대한민국, 영국, 미국. 
  
자세한 내용은 [Office 365에서 Multi-Geo 소개를 참조합니다.](https://techcommunity.microsoft.com/t5/Security-Privacy-and-Compliance/Introducing-Multi-Geo-in-Office-365/ba-p/107016)
  
## <a name="feature-availability-across-plans"></a>계획에서 사용 가능한 기능

다음 표에는 모든 플랫폼 기능이 나열됩니다.
  
다양한 비즈니스에 종류에 대한 가격 책정 및 기능에 대한 구체적인 정보를 보려면 다음 페이지를 참조하세요.
  
- 비즈니스: [비즈니스용 Microsoft 365 요금제 및 가격](https://go.microsoft.com/fwlink/?LinkID=827896)
...
- 비영리: [비영리용 Microsoft 365 및 Office 365 제품 비교](https://go.microsoft.com/fwlink/?LinkID=733237)

- Office 365 Germany: [Office 365 Germany 계획](https://go.microsoft.com/fwlink/?linkid=839016)
    
일부 비즈니스용 Microsoft 365 요금제에는 구독을 위해 구입할 수 있는 추가 기능도 있습니다. 추가 기능은 구독에 대한 추가 기능을 제공합니다. 자세한 내용은 추가 기능 구입 [또는 관리를 참조하세요.](https://docs.microsoft.com/microsoft-365/commerce/buy-or-edit-an-add-on)
<br><br>
...
|Azure Information Protection을 사용하여 콘텐츠 보호  <br/> |<sup>아니요 2</sup> <br/> |<sup>아니요 2</sup> <br/> |<sup>아니요 2</sup> <br/> |<sup>아니요 2</sup> <br/> |예  <br/> |예  <br/> |<sup>아니요 2</sup> <br/> |
...
|웹용 Microsoft Project <sup>21</sup> <br/> |예 <br/> |아니요 <br/>|예 <br/> |예 <br/> |예 <br/> |예 <br/> | 예 <br/> |
|Microsoft SharePoint Syntex  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |
...
|Office 365 데스크톱 설정  <br/> |예  <br/> |아니요  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |
...
|Microsoft 365에서 계정 삭제 및 사용자 암호 다시 설정 또는 Windows PowerShell<sup>3</sup> <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |
|사용자가 자신의 암호를 변경할 수 있음<sup>4</sup> <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |
|라이선스 관리  <br/> |예<sup>6</sup> <br/> |예<sup>6</sup> <br/> |예<sup>6</sup> <br/> |예<sup>6</sup> <br/> |예<sup>6</sup> <br/> |예<sup>6</sup> <br/> |예<sup>6</sup> <br/> |
|Microsoft 365에서 보안 그룹 관리  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |
|사용할 수 있는 여러 관리자 역할  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |
|파트너가 Microsoft 365를 관리할 수 있도록 허용  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |
...
|Office 365에서 관리되는 DNS 레코드(완전 재위임)  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |
...
|Microsoft 365 관리 센터 대시보드에서 사용할 수 있는 개별 경고 상태  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |
...
|메일에 대한 상위 DLP 정책 일치  <br/> |아니요  <br/> |아니요  <br/> |아니요  <br/> |아니요  <br/> |예  <br/> |예  <br/> |아니요  <br/> |
|메일에 대한 심각도별 DLP 정책 일치  <br/> |아니요  <br/> |아니요  <br/> |아니요  <br/> |아니요  <br/> |예  <br/> |예  <br/> |아니요  <br/> |
|메일에 대한 DLP 정책 일치, 재정의 및 가양성  <br/> |아니요  <br/> |아니요  <br/> |아니요  <br/> |아니요  <br/> |예  <br/> |예  <br/> |아니요  <br/> |
|메일에 대한 상위 DLP 규칙 일치  <br/> |아니요  <br/> |아니요  <br/> |아니요  <br/> |아니요  <br/> |예  <br/> |예  <br/> |아니요  <br/> |
...
|Microsoft 365 보고 웹 서비스를 사용하여 자체 보고서 만들기  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |
...
|Office 365용 Microsoft Defender  <br/> |아니요  <br/> |아니요  <br/> |아니요  <br/> |아니요  <br/> |아니요  <br/> |예  <br/> |아니요  <br/> |
...
|EU Safe Harbor  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |
|HIPAA-BAA(사업 협력 계약)  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |예  <br/> |
...
<br/><sup>2</sup> Azure Information Protection은 포함되어 있지 않지만 별도의 추가 기능으로 구입할 수 있으며 지원되는 IRM(정보 권한 관리) 기능을 사용하도록 설정할 수 있습니다. 일부 Azure Information Protection 기능을 사용하려면 Microsoft 365 Business Basic, Microsoft 365 Business Standard, Office 365 Enterprise E1, Office 365 Education 또는 Office 365 Enterprise F3에 포함되지 않은 엔터프라이즈용 Microsoft 365 앱을 구독해야 합니다. 비즈니스용 Microsoft 365 앱과 함께 제공된 Office 클라이언트 앱은 전체 Azure Information Protection(계획 1) 기능도 지원됩니다.
<br/><sup>3</sup> 로컬 Active Directory와 디렉터리 동기화를 사용하는 경우 Azure Active Directory 모듈을 사용하여 Microsoft 365 포털이 아닌 로컬 Active Directory를 사용하여 계정을 삭제하거나 암호를 변경해야 Windows PowerShell. 
<br/><sup>4</sup> 사용자에 대한 셀프 서비스 암호 관리 정책을 설정하는 방법에 대한 자세한 내용은 보안 정보를 사용하여 직장 또는 학교 암호 재설정을 [참조하세요.](https://azure.microsoft.com/documentation/articles/active-directory-manage-passwords/) 
...
<br/><sup>8</sup> Microsoft Sway는 현재 특정 지리의 고객은 사용할 수 없습니다. 2015년 8월 현재 더 이상 출시되지 않는 일부 레거시 Office 365 요금제는 Microsoft Sway에 액세스할 수 없습니다. 
<br/><sup>9</sup> 환경이 희미해진 경우 조직에서 이전 웹앱 및 서비스에 Internet Explorer 8 또는 Internet Explorer 9 액세스하는 데 의존하는 경우 Internet Explorer 11로 업그레이드하고 Internet Explorer 11에 대한 엔터프라이즈 모드를 평가할 수 있습니다. 이 업데이트를 통해 레거시 Web Apps에 대한 이전 버전과의 호환성을 개선할 수 있습니다. 
...
<br/><sup>Office</sup> 365 Enterprise F3에서 흐름은 사용만 제한하며 실행은 월별 사용자당 750명으로 제한됩니다. 
<br/><sup>13</sup> Office 365 E5 Education을 포함하여 Office 365 Education 요금제에서만 사용할 수 있습니다. Office 365 Enterprise E5에서는 사용할 수 없습니다. 
...
<br/><sup>16</sup> Microsoft Stream에만 사용: 게시 또는 공유 없음
<br/><sup>17</sup> 2019년 5월부터는 Office 365 및 Microsoft 365의 기존 적격 SKUS가 Kaizala Pro로 백업됩니다. 2019년 6월 1일부터 Kaizala Pro는 모든 적합한 Office 365 및 Microsoft 365 SKUS에 포함됩니다.
<br/><sup>18</sup> 자세한 내용은 [MyAnalytics](https://docs.microsoft.com/workplace-analytics/myanalytics/overview/plans-environments)계획 및 환경을 참조하세요.
<br/><sup>19</sup> Azure Active Directory 가격 페이지의 **Office 365** 앱 열에 설명된 [Azure Active Directory 기능이 포함되어](https://azure.microsoft.com/pricing/details/active-directory/) 있습니다. 고급 Azure AD 기능을 사용하려면 Azure Active Directory 계획 1 또는 계획 2, Enterprise Mobile Security 또는 Microsoft 365 E3 또는 E5를 추가해야 합니다.<br/>
<sup>20</sup> Exchange Online의 모든 사용자에게 브리핑 전자 메일이 자동으로 제공됩니다. 자세한 내용은 [브리핑 전자 메일 구성을 참조하세요.](https://docs.microsoft.com/Briefing/be-admin)<br>
<sup>21</sup> 사용자에게는 웹용 Project에 대한 보기 전용 액세스 권한이 제공됩니다. 이러한 권한은 웹 응용 프로그램에 대한 Project 및 Project Plan 1, Project Plan 3 또는 Project Plan 5 라이선스가 있는 테넌트에만 사용할 수 있습니다. 이러한 권한은 Power Platform 응용 프로그램 또는 기타 데이터 집합, Project Online 데스크톱 클라이언트 또는 Project Online에 대한 액세스 권한을 부여하지 않습니다. 기능 세부 정보는 Microsoft Project 서비스 [설명을 참조하세요.](../project-online-service-description/project-online-service-description.md)<br/>
Microsoft 365의 <sup>22</sup> 감사는 조직에 Microsoft 365의 여러 서비스에서 다양한 유형의 감사 활동을 가시성을 제공합니다. 보안 준수 [ &amp; 센터](https://docs.microsoft.com/office365/servicedescriptions/office-365-platform-service-description/office-365-securitycompliance-center) 감사 로그 검색을 사용하여 조직의 사용자 및 관리자 활동을 볼 수 있습니다. [Office 365](https://docs.microsoft.com/office/office-365-management-api/office-365-management-activity-api-reference) 관리 활동 API를 사용하여 통합 감사 로그에서 이벤트를 검색할 수도 있습니다. 사용자 또는 관리자가 감사 활동을 수행하면 감사 레코드가 생성되어 고객 조직에 대한 감사 로그에 저장됩니다. 감사 레코드가 보존되는 기간(감사 로그에서 검색 가능)은 고객의 Office 365 또는 Microsoft 365 Enterprise 구독 및 특정 사용자에게 할당된 라이선스 유형에 따라 다릅니다.

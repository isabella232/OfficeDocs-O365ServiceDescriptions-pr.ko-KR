...
|조직당 사이트(사이트 모음)  <br/> |2,005<sup></sup> <br/> |2,005<sup></sup> <br/> |2백만<br/> |
|사용자 수  <br/> |최대 300  <br/> |1- 500,0006<sup></sup> <br/> |1- 500,0006<sup></sup> <br/> |
...
<br/> <sup>5</sup> 사용이 허가된 각 사용자에 대해 OneDrive 만들 수 없습니다. 
...
- 파일 이름을 포함하여 디코딩된 전체 파일 경로는 OneDrive 또는 학교 및 OneDrive 400자 이상을 SharePoint Microsoft 365. 이 제한은 디코딩 후 폴더 경로와 파일 이름의 조합에 적용됩니다. 자세한 내용은 파일 이름 및 경로  [길이로 이동하세요](https://support.microsoft.com/office/restrictions-and-limitations-in-onedrive-and-sharepoint-64883a5d-228e-48f5-b3d2-eb39e07630fa#filenamepathlengths).
...
> [!NOTE]
> 조직은 2,000개의 허브 사이트로 제한됩니다. 일부 기능에는 허브 사이트가 필요하지 않을 수 있으며 허브를 만들기 전에 몇 가지 계획을 세우는 것이 중요합니다. 자세한 내용은 [Planning your SharePoint hub sites을 참조하십시오](/sharepoint/planning-hub-sites).
...
SharePoint 또는 명시적 중지 작업이 없는 경우 2013 워크플로를 디자인에 따라 순차적으로 실행할 수 있습니다.
